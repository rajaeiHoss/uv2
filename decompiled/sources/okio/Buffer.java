...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public short readShort() {
        if (this.size >= 2) {
            ...
            int i3 = i + 1;
            int i4 = i3 + 1;
            int b = ((bArr[i] & UByte.MAX_VALUE) << 8) | (bArr[i3] & UByte.MAX_VALUE);
            this.size -= 2;
            if (i4 == i2) {
                this.head = segment.pop();
                SegmentPool.recycle(segment);
    ...
    public int readInt() {
        if (this.size >= 4) {
            ...
            int i3 = i + 1;
            int i4 = i3 + 1;
            int b = ((bArr[i] & UByte.MAX_VALUE) << 24) | ((bArr[i3] & UByte.MAX_VALUE) << 16);
            int i5 = i4 + 1;
            int b2 = b | ((bArr[i4] & UByte.MAX_VALUE) << 8);
            int i6 = i5 + 1;
            int b3 = b2 | (bArr[i5] & UByte.MAX_VALUE);
            this.size -= 4;
            if (i6 == i2) {
                this.head = segment.pop();
                SegmentPool.recycle(segment);
        ...
        if (str == null) {
            ...
            while (i < i2) {
                ...
                if (charAt < 128) {
                    ...
                    if (charAt < 2048) {
                        writeByte((charAt >> 6) | Wbxml.EXT_0);
    ...
    public long indexOfElement(ByteString byteString, long j) {
        ...
        if (size - j < j) {
            ...
            while (true) {
                long nextOffset = ((long) (segment.limit - segment.pos)) + offset;
                if (nextOffset >= j) {
                    break;
                }
                segment = segment.next;
        ...
        if (byteString.size() == 2) {
            ...
            while (offset < this.size) {
                ...
                int i = (int) ((((long) segment.pos) + j) - offset);
                int limit = segment.limit;
                while (i < limit) {
                    byte b3 = data[i];
                    if (b3 == b || b3 == b2) {
                        return ((long) (i - segment.pos)) + offset;
                    }
                    i++;
                }
                offset += (long) (segment.limit - segment.pos);
        ...
        while (offset < this.size) {
            ...
            int i2 = (int) ((((long) segment.pos) + j) - offset);
            int limit2 = segment.limit;
            while (i2 < limit2) {
                byte b4 = data2[i2];
                for (byte b5 : internalArray) {
                    if (b4 == b5) {
                        return ((long) (i2 - segment.pos)) + offset;
                    }
                }
                i2++;
            }
    ...
    public final ByteString sha1() {
        return digest(EntityCapsManager.HASH_METHOD_CAPS);
    }
