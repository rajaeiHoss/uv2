...
public class InBandBytestreamManager implements BytestreamManager {
    ...
    public static synchronized org.jivesoftware.smackx.bytestreams.ibb.InBandBytestreamManager getByteStreamManager(org.jivesoftware.smack.Connection r3) {
        /*
            ...
            return r3
        L_0x0008:
            java.util.Map<org.jivesoftware.smack.Connection, org.jivesoftware.smackx.bytestreams.ibb.InBandBytestreamManager> r1 = managers     // Catch:{ all -> 0x001c }
    ...
    private InBandBytestreamManager(Connection connection2) {
        ...
        connection2.addPacketListener(dataListener2, dataListener2.getFilter());
        CloseListener closeListener2 = new CloseListener(this);
        this.closeListener = closeListener2;
        connection2.addPacketListener(closeListener2, closeListener2.getFilter());
    }
