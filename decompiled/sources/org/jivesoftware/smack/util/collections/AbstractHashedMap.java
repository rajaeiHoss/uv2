...
public class AbstractHashedMap<K, V> extends AbstractMap<K, V> implements IterableMap<K, V> {
    ...
    public void putAll(Map<? extends K, ? extends V> map) {
        ...
        if (size2 != 0) {
            ...
            for (Map.Entry<? extends K, ? extends V> next : map.entrySet()) {
    ...
    public void reuseEntry(HashEntry<K, V> hashEntry, int i, int i2, K k, V v) {
        ...
        Object unused = hashEntry.key = k;
        Object unused2 = hashEntry.value = v;
    }
    ...
    public void destroyEntry(HashEntry<K, V> hashEntry) {
        hashEntry.next = null;
        Object unused = hashEntry.key = null;
        Object unused2 = hashEntry.value = null;
    }
    ...
    public void doReadObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        ...
        for (int i = 0; i < readInt2; i++) {
            put((K) objectInputStream.readObject(), (V) objectInputStream.readObject());
        }
