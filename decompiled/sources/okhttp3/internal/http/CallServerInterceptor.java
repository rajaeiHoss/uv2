...
public final class CallServerInterceptor implements Interceptor {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (PreviewActivity.ON_CLICK_LISTENER_CLOSE.equalsIgnoreCase(response.request().header("Connection")) || PreviewActivity.ON_CLICK_LISTENER_CLOSE.equalsIgnoreCase(response.header("Connection"))) {
            streamAllocation.noNewStreams();
        }
