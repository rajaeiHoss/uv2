                    ...
                    public void run() {
                        final DiffUtil.DiffResult calculateDiff = DiffUtil.calculateDiff(new DiffUtil.Callback() {
                            ...
                            public boolean areItemsTheSame(int i, int i2) {
                                ...
                                return AsyncListDiffer.this.mConfig.getDiffCallback().areItemsTheSame((T) obj, (T) obj2);
                            }
                            ...
                            public boolean areContentsTheSame(int i, int i2) {
                                ...
                                Object obj2 = list4.get(i2);
                                if (obj != null && obj2 != null) {
                                    return AsyncListDiffer.this.mConfig.getDiffCallback().areContentsTheSame((T) obj, (T) obj2);
                                }
                                if (obj == null && obj2 == null) {
                                    return true;
                                }
                            ...
                            public Object getChangePayload(int i, int i2) {
                                ...
                                Object obj2 = list4.get(i2);
                                if (obj != null && obj2 != null) {
                                    return AsyncListDiffer.this.mConfig.getDiffCallback().getChangePayload((T) obj, (T) obj2);
                                }
                                throw new AssertionError();
                            }
                        });
