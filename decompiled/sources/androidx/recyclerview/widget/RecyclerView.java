...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
        ...
        if (str != null) {
            ...
            if (!trim.isEmpty()) {
                ...
                try {
                    ...
                    Class<? extends LayoutManager> asSubclass = Class.forName(fullClassName, false, classLoader).asSubclass(LayoutManager.class);
                    Object[] objArr = null;
                    try {
    ...
    public static abstract class LayoutManager {
        ...
        public LayoutManager() {
            ViewBoundsCheck.Callback r0 = new ViewBoundsCheck.Callback() {
                public View getChildAt(int i) {
            ...
            ViewBoundsCheck.Callback r1 = new ViewBoundsCheck.Callback() {
                public View getChildAt(int i) {
                    return LayoutManager.this.getChildAt(i);
                }
