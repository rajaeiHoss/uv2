...
public class SortedList<T> {
    ...
    public SortedList(Class<T> cls, Callback<T> callback, int i) {
        this.mTClass = cls;
        this.mData = (T[]) Array.newInstance(cls, i);
    ...
    public void addAll(Collection<T> collection) {
        addAll(collection.toArray((T[]) Array.newInstance(this.mTClass, collection.size())), true);
    }
    ...
    public void replaceAll(Collection<T> collection) {
        replaceAll(collection.toArray((T[]) Array.newInstance(this.mTClass, collection.size())), true);
    }
    ...
    private void merge(T[] tArr, int i) {
        ...
        this.mData = (T[]) Array.newInstance(this.mTClass, i3 + i + 10);
        this.mNewDataStart = 0;
        while (true) {
    ...
    private void addToData(int i, T t) {
        ...
        if (i <= i2) {
            T[] tArr = this.mData;
            if (i2 == tArr.length) {
                T[] tArr2 = (T[]) Array.newInstance(this.mTClass, tArr.length + 10);
    ...
    private T[] copyArray(T[] tArr) {
        T[] tArr2 = (T[]) Array.newInstance(this.mTClass, tArr.length);
