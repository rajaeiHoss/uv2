...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    static {
        ...
        ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(5, 128, 1, TimeUnit.SECONDS, linkedBlockingQueue, threadFactory);
    ...
    ModernAsyncTask() {
        WorkerRunnable<Params, Result> worker = new WorkerRunnable<Params, Result>() {
