            ...
            public <I, O> void onLaunch(final int i, ActivityResultContract<I, O> activityResultContract, I i2, ActivityOptionsCompat activityOptionsCompat) {
                ...
                if (synchronousResult != null) {
                    new Handler(Looper.getMainLooper()).post(new Runnable() {
                        public void run() {
                            ComponentActivity.this.mActivityResultRegistry.dispatchResult(i, synchronousResult.getValue());
                        }
                    });
                    return;
                }
                ...
                if (ActivityResultContracts.RequestMultiplePermissions.ACTION_REQUEST_PERMISSIONS.equals(createIntent.getAction())) {
                    ...
                    try {
                        ...
                        new Handler(Looper.getMainLooper()).post(new Runnable() {
                            public void run() {
                                ComponentActivity.this.mActivityResultRegistry.dispatchResult(i, 0, new Intent().setAction(ActivityResultContracts.StartIntentSenderForResult.ACTION_INTENT_SENDER_REQUEST).putExtra(ActivityResultContracts.StartIntentSenderForResult.EXTRA_SEND_INTENT_EXCEPTION, e));
                            }
                        });
                    }
                } else {
