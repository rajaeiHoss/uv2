...
class AlertController {
    ...
    private void setupView() {
        ...
        if (!z) {
            ...
            if (view2 != null) {
                setScrollIndicators(resolvePanel2, view2, (z2 ? 1 : 0) | (z3 ? 2 : 0), 3);
            }
        }
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        ...
        if (findViewById != null || findViewById2 != null) {
            final View scrollIndicatorUp = findViewById;
            final View scrollIndicatorDown = findViewById2;
            if (this.mMessage != null) {
                this.mScrollView.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener() {
                    public void onScrollChange(NestedScrollView nestedScrollView, int i, int i2, int i3, int i4) {
                        AlertController.manageScrollIndicators(nestedScrollView, scrollIndicatorUp, scrollIndicatorDown);
                    }
                });
                this.mScrollView.post(new Runnable() {
                    public void run() {
                        AlertController.manageScrollIndicators(AlertController.this.mScrollView, scrollIndicatorUp, scrollIndicatorDown);
                    }
                });
                return;
            }
            ...
            if (listView != null) {
                listView.setOnScrollListener(new AbsListView.OnScrollListener() {
                    ...
                    public void onScroll(AbsListView absListView, int i, int i2, int i3) {
                        AlertController.manageScrollIndicators(absListView, scrollIndicatorUp, scrollIndicatorDown);
                    }
                });
                this.mListView.post(new Runnable() {
                    public void run() {
                        AlertController.manageScrollIndicators(AlertController.this.mListView, scrollIndicatorUp, scrollIndicatorDown);
                    }
                });
                return;
            }
