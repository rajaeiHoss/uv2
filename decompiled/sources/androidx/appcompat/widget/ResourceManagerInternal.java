            ...
            try {
                ...
                if (xml.getEventType() == 2) {
                    ...
                    if (inflateDelegate != null) {
                        Drawable createFromXmlInner = inflateDelegate.createFromXmlInner(context, xml, asAttributeSet, context.getTheme());
                        if (createFromXmlInner != null) {
                            createFromXmlInner.setChangingConfigurations(typedValue.changingConfigurations);
                            addDrawableToCache(context, createCacheKey, createFromXmlInner);
