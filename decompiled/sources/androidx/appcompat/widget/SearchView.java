...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        searchAutoComplete.setOnEditorActionListener(editorActionListener);
        searchAutoComplete.setOnItemClickListener(itemClickListener);
        searchAutoComplete.setOnItemSelectedListener(itemSelectedListener);
    ...
    static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            return "SearchView.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " isIconified=" + this.isIconified + Constants.JsonSstringSuffix;
        }
    }
