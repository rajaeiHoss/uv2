...
public final class SavedStateRegistry {
    ...
    public void performSave(Bundle bundle) {
        ...
        Iterator<Map.Entry<String, SavedStateProvider>> iteratorWithAdditions = this.mComponents.iteratorWithAdditions();
        while (iteratorWithAdditions.hasNext()) {
            Map.Entry<String, SavedStateProvider> entry = iteratorWithAdditions.next();
            bundle2.putBundle(entry.getKey(), entry.getValue().saveState());
        }
