...
public class VerticalWidgetRun extends WidgetRun {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                iArr[androidx.constraintlayout.solver.widgets.analyzer.WidgetRun.RunType.END.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                iArr[androidx.constraintlayout.solver.widgets.analyzer.WidgetRun.RunType.CENTER.ordinal()] = 3;
    ...
    public void update(Dependency dependency) {
        ...
        if (this.dimension.readyToSolve && !this.dimension.resolved && this.dimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            ...
            if (i3 == 2) {
                ...
                } else if (dimensionRatioSide == 1 || dimensionRatioSide == -1) {
                    f = ((float) this.widget.horizontalRun.dimension.value) / this.widget.getDimensionRatio();
                } else {
                    i = 0;
