...
public class SolverVariable {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                iArr[androidx.constraintlayout.solver.SolverVariable.Type.CONSTANT.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                iArr[androidx.constraintlayout.solver.SolverVariable.Type.SLACK.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                iArr[androidx.constraintlayout.solver.SolverVariable.Type.ERROR.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                iArr[androidx.constraintlayout.solver.SolverVariable.Type.UNKNOWN.ordinal()] = 5;
