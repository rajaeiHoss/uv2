    ...
    public SolverVariable chooseSubjectInVariables(LinearSystem linearSystem) {
        ...
        for (int i = 0; i < currentSize; i++) {
            ...
            if (variable2.mType == SolverVariable.Type.UNRESTRICTED) {
                boolean isNewCandidate = isNew(variable2, linearSystem);
                if (solverVariable == null || f > variableValue || (!z && isNewCandidate)) {
                    f = variableValue;
                    solverVariable = variable2;
                    z = isNewCandidate;
                }
            } else if (solverVariable == null && variableValue < 0.0f) {
                boolean isNewCandidate2 = isNew(variable2, linearSystem);
                if (solverVariable2 == null || f2 > variableValue || (!z2 && isNewCandidate2)) {
                    f2 = variableValue;
