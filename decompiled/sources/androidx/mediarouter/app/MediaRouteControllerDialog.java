...
public class MediaRouteControllerDialog extends AlertDialog {
    ...
    public MediaRouteControllerDialog(Context context, int i) {
        super(MediaRouterThemeHelper.createThemedDialogContext(context, i, true), MediaRouterThemeHelper.createThemedDialogStyle(MediaRouterThemeHelper.createThemedDialogContext(context, i, true)));
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            this.mLinearOutSlowInInterpolator = android.view.animation.AnimationUtils.loadInterpolator(this.mContext, R.interpolator.mr_linear_out_slow_in);
            this.mFastOutSlowInInterpolator = android.view.animation.AnimationUtils.loadInterpolator(this.mContext, R.interpolator.mr_fast_out_slow_in);
        }
        this.mAccelerateDecelerateInterpolator = new android.view.animation.AccelerateDecelerateInterpolator();
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        View.OnClickListener openSessionClickListener = new View.OnClickListener() {
            public void onClick(View view) {
        ...
        imageView.setOnClickListener(openSessionClickListener);
        findViewById(R.id.mr_control_title_container).setOnClickListener(openSessionClickListener);
    ...
    public void updateLayoutHeightInternal(boolean z) {
        ...
        if (getGroup() == null) {
            ...
            i2 = this.mVolumeGroupListItemHeight * getGroup().getRoutes().size();
        }
        if (size > 0) {
    ...
    private void animateLayoutHeight(final View view, final int i) {
        ...
        heightAnimation.setDuration((long) this.mGroupListAnimationDurationMs);
        if (Build.VERSION.SDK_INT >= 21) {
            heightAnimation.setInterpolator(this.mInterpolator);
        }
    ...
    public void animateGroupListItemsInternal(Map<MediaRouter.RouteInfo, Rect> map, Map<MediaRouter.RouteInfo, BitmapDrawable> map2) {
        ...
        if (set != null && this.mGroupMemberRoutesRemoved != null) {
            ...
            for (int i = 0; i < this.mVolumeGroupList.getChildCount(); i++) {
                ...
                if (!z) {
                    animationSet.setAnimationListener(fadeInListener);
                    z = true;
                }
    ...
    private void fadeInAddedRoutes() {
        ...
        for (int i = 0; i < this.mVolumeGroupList.getChildCount(); i++) {
            ...
            if (this.mGroupMemberRoutesAdded.contains((MediaRouter.RouteInfo) volumeGroupAdapter.getItem(firstVisiblePosition + i))) {
                ...
                if (!z) {
                    alphaAnimation.setAnimationListener(fadeInListener);
                    z = true;
                }
                childAt.clearAnimation();
