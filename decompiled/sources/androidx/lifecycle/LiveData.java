    ...
    public void dispatchingValue(LiveData<T>.ObserverWrapper observerWrapper) {
        ...
        do {
            ...
            if (observerWrapper == null) {
                Iterator<Map.Entry<Observer<? super T>, LiveData<T>.ObserverWrapper>> iteratorWithAdditions = this.mObservers.iteratorWithAdditions();
