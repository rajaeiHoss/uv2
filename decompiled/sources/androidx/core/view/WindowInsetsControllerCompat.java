            ...
            if (i == 1) {
                ...
                if (view != null && view.hasWindowFocus()) {
                    ...
                    view.post(new Runnable() {
                        public void run() {
                            ((InputMethodManager) targetView.getContext().getSystemService("input_method")).showSoftInput(targetView, 0);
                        }
                    });
                }
            }
    ...
    private static class Impl30 extends Impl {
        ...
        public void addOnControllableInsetsChangedListener(final OnControllableInsetsChangedListener onControllableInsetsChangedListener) {
            if (!this.mListeners.containsKey(onControllableInsetsChangedListener)) {
                WindowInsetsController.OnControllableInsetsChangedListener listener = new WindowInsetsController.OnControllableInsetsChangedListener() {
                ...
                this.mListeners.put(onControllableInsetsChangedListener, listener);
                this.mInsetsController.addOnControllableInsetsChangedListener(listener);
            }
        }
