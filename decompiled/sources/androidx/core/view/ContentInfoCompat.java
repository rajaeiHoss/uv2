...
public final class ContentInfoCompat {
    ...
    public String toString() {
        return "ContentInfoCompat{clip=" + this.mClip + ", source=" + sourceToString(this.mSource) + ", flags=" + flagsToString(this.mFlags) + ", linkUri=" + this.mLinkUri + ", extras=" + this.mExtras + Constants.JsonSstringSuffix;
    }
    ...
    public Pair<ContentInfoCompat, ContentInfoCompat> partition(Predicate<ClipData.Item> predicate) {
        ...
        if (arrayList.isEmpty()) {
            return Pair.create((ContentInfoCompat) null, this);
        }
        if (arrayList2.isEmpty()) {
            return Pair.create(this, (ContentInfoCompat) null);
        }
