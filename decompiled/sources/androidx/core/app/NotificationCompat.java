...
public class NotificationCompat {
        ...
        public static final class Builder {
            ...
            public static Builder fromAndroidAction(Notification.Action action) {
                ...
                if (!(Build.VERSION.SDK_INT < 20 || (remoteInputs = action.getRemoteInputs()) == null || remoteInputs.length == 0)) {
                    for (android.app.RemoteInput fromPlatform : remoteInputs) {
    ...
    public static final class WearableExtender implements Extender {
        ...
        private static Notification.Action getActionFromActionCompat(Action action) {
            ...
            if (remoteInputs != null) {
                for (android.app.RemoteInput addRemoteInput : RemoteInput.fromCompat(remoteInputs)) {
    ...
    public static final class CarExtender implements Extender {
        ...
        private static UnreadConversation getUnreadConversationFromBundle(Bundle bundle) {
            ...
            android.app.RemoteInput remoteInput2 = (android.app.RemoteInput) bundle2.getParcelable(KEY_REMOTE_INPUT);
            String[] stringArray = bundle2.getStringArray(KEY_PARTICIPANTS);
            if (stringArray == null || stringArray.length != 1) {
                return null;
            }
            if (remoteInput2 != null) {
                remoteInput = RemoteInput.fromPlatform(remoteInput2);
            }
        ...
        private static Bundle getBundleForUnreadConversation(UnreadConversation unreadConversation) {
            ...
            if (remoteInput != null) {
                bundle.putParcelable(KEY_REMOTE_INPUT, RemoteInput.fromCompat(remoteInput));
            }
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (remoteInputs == null) {
            ...
            for (int i2 = 0; i2 < remoteInputs.length; i2++) {
                ...
                remoteInputArr2[i2] = RemoteInput.fromPlatform(remoteInput);
            }
