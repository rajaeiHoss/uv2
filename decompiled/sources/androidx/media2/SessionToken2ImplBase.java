...
final class SessionToken2ImplBase implements SessionToken2.SessionToken2Impl {
    ...
    public String toString() {
        return "SessionToken {pkg=" + this.mPackageName + " id=" + this.mSessionId + " type=" + this.mType + " service=" + this.mServiceName + " IMediaSession2=" + this.mISession2 + Constants.JsonSstringSuffix;
    }
