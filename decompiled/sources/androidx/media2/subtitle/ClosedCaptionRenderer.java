    ...
    class Cea608CCWidget extends ClosedCaptionWidget implements Cea608CCParser.DisplayListener {
        ...
        private class CCLayout extends LinearLayout implements ClosedCaptionWidget.ClosedCaptionLayout {
            ...
            public void onMeasure(int i, int i2) {
                ...
                int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(((int) (((float) measuredHeight) * SAFE_AREA_RATIO)) / 15, BasicMeasure.EXACTLY);
                int makeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec((int) (((float) measuredWidth) * SAFE_AREA_RATIO), BasicMeasure.EXACTLY);
            ...
            public void onLayout(boolean z, int i, int i2, int i3, int i4) {
                ...
                int i11 = (int) (((float) i5) * SAFE_AREA_RATIO);
                int i12 = (int) (((float) i6) * SAFE_AREA_RATIO);
                int i13 = (i7 - i11) / 2;
                int i14 = (i8 - i12) / 2;
                int i15 = 0;
                while (i15 < 15) {
