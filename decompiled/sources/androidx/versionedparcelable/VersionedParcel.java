...
public abstract class VersionedParcel {
            ...
            switch (type) {
                case 1:
                    for (T writeVersionedParcelable : collection) {
                        writeVersionedParcelable((VersionedParcelable) writeVersionedParcelable);
                    }
                    return;
                case 2:
                    for (T writeParcelable : collection) {
                        writeParcelable((Parcelable) writeParcelable);
                    }
                    return;
                case 3:
                    for (T writeSerializable : collection) {
                        writeSerializable((Serializable) writeSerializable);
                    }
                    return;
                case 4:
                ...
                case 5:
                    for (T writeStrongBinder : collection) {
                        writeStrongBinder((IBinder) writeStrongBinder);
                    }
                    return;
                case 7:
                    for (T intValue : collection) {
                        writeInt(((Integer) intValue).intValue());
                    }
                    return;
                case 8:
                    for (T floatValue : collection) {
                        writeFloat(((Float) floatValue).floatValue());
                    }
                    return;
                default:
                    return;
    ...
    private <T, S extends Collection<T>> S readCollection(S s) {
        ...
        if (readInt != 0) {
            ...
            if (readInt2 == 1) {
                while (readInt > 0) {
                    s.add((T) readVersionedParcelable());
                    readInt--;
                }
            } else if (readInt2 == 2) {
                while (readInt > 0) {
                    s.add((T) readParcelable());
                    readInt--;
                }
            } else if (readInt2 == 3) {
                while (readInt > 0) {
    ...
    public <T> T[] readArray(T[] tArr) {
        ...
        if (readInt != 0) {
            ...
            if (readInt2 == 1) {
                while (readInt > 0) {
                    arrayList.add((T) readVersionedParcelable());
                    readInt--;
                }
            } else if (readInt2 == 2) {
                while (readInt > 0) {
                    arrayList.add((T) readParcelable());
                    readInt--;
                }
            } else if (readInt2 == 3) {
                while (readInt > 0) {
                    arrayList.add((T) readSerializable());
                    readInt--;
                }
            } else if (readInt2 == 4) {
                while (readInt > 0) {
                    arrayList.add((T) readString());
                    readInt--;
                }
            } else if (readInt2 == 5) {
                while (readInt > 0) {
                    arrayList.add((T) readStrongBinder());
                    readInt--;
                }
            }
        }
    ...
    public <T extends VersionedParcelable> T readFromParcel(String str, VersionedParcel versionedParcel) {
        try {
            return (T) getReadMethod(str).invoke((Object) null, new Object[]{versionedParcel});
