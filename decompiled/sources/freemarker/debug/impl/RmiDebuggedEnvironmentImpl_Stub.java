...
public final class RmiDebuggedEnvironmentImpl_Stub extends RemoteStub implements DebuggedEnvironment, DebugModel, Remote {
    ...
    private static Method $method_getId_10 = null;
    private static Method $method_getModelTypes_11 = null;
    ...
    private static Method $method_keys_12 = null;
    private static Method $method_resume_13 = null;
    private static Method $method_size_14 = null;
    private static Method $method_stop_15 = null;
    static /* synthetic */ Class array$Ljava$lang$String = null;
    static /* synthetic */ Class class$freemarker$debug$DebugModel = null;
    static /* synthetic */ Class class$freemarker$debug$DebuggedEnvironment = null;
    ...
    static {
        try {
            ...
            Class cls13 = class$freemarker$debug$DebuggedEnvironment;
            if (cls13 == null) {
                cls13 = class$("freemarker.debug.DebuggedEnvironment");
                class$freemarker$debug$DebuggedEnvironment = cls13;
            }
            $method_getId_10 = cls13.getMethod("getId", new Class[0]);
            ...
            $method_getModelTypes_11 = cls14.getMethod("getModelTypes", new Class[0]);
            ...
            $method_keys_12 = cls15.getMethod("keys", new Class[0]);
            Class cls16 = class$freemarker$debug$DebuggedEnvironment;
            if (cls16 == null) {
                cls16 = class$("freemarker.debug.DebuggedEnvironment");
                class$freemarker$debug$DebuggedEnvironment = cls16;
            }
            $method_resume_13 = cls16.getMethod("resume", new Class[0]);
            Class cls17 = class$freemarker$debug$DebugModel;
            if (cls17 == null) {
                cls17 = class$("freemarker.debug.DebugModel");
                class$freemarker$debug$DebugModel = cls17;
            }
            $method_size_14 = cls17.getMethod("size", new Class[0]);
            Class cls18 = class$freemarker$debug$DebuggedEnvironment;
            if (cls18 == null) {
                cls18 = class$("freemarker.debug.DebuggedEnvironment");
                class$freemarker$debug$DebuggedEnvironment = cls18;
            }
            $method_stop_15 = cls18.getMethod("stop", new Class[0]);
    ...
    public long getId() throws RemoteException {
        try {
            return ((Long) this.ref.invoke(this, $method_getId_10, (Object[]) null, -6040770469254561000L)).longValue();
        } catch (RuntimeException e) {
            throw e;
        } catch (RemoteException e2) {
            throw e2;
    ...
    public int getModelTypes() throws RemoteException {
        try {
            return ((Integer) this.ref.invoke(this, $method_getModelTypes_11, (Object[]) null, -3673171458095957561L)).intValue();
        } catch (RuntimeException e) {
            throw e;
        } catch (RemoteException e2) {
            throw e2;
    ...
    public String[] keys() throws TemplateModelException, RemoteException {
        try {
            return (String[]) this.ref.invoke(this, $method_keys_12, (Object[]) null, 563174456558742983L);
        } catch (RuntimeException e) {
            throw e;
        } catch (RemoteException e2) {
            throw e2;
    ...
    public void resume() throws RemoteException {
        try {
            this.ref.invoke(this, $method_resume_13, (Object[]) null, 4126995468303716546L);
        } catch (RuntimeException e) {
            throw e;
        } catch (RemoteException e2) {
            throw e2;
    ...
    public int size() throws TemplateModelException, RemoteException {
        try {
            return ((Integer) this.ref.invoke(this, $method_size_14, (Object[]) null, 4495240443643581991L)).intValue();
        } catch (RuntimeException e) {
            throw e;
        } catch (RemoteException e2) {
            throw e2;
    ...
    public void stop() throws RemoteException {
        try {
            this.ref.invoke(this, $method_stop_15, (Object[]) null, -2856118408655404442L);
        } catch (RuntimeException e) {
            throw e;
        } catch (RemoteException e2) {
            throw e2;
