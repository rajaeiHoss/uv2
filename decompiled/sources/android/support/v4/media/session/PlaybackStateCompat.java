...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public String toString() {
        return "PlaybackState {" + "state=" + this.mState + ", position=" + this.mPosition + ", buffered position=" + this.mBufferedPosition + ", speed=" + this.mSpeed + ", updated=" + this.mUpdateTime + ", actions=" + this.mActions + ", error code=" + this.mErrorCode + ", error message=" + this.mErrorMessage + ", custom actions=" + this.mCustomActions + ", active item id=" + this.mActiveItemId + Constants.JsonSstringSuffix;
    }
    ...
    public static PlaybackStateCompat fromPlaybackState(Object obj) {
        ...
        List<android.media.session.PlaybackState.CustomAction> customActions = PlaybackStateCompatApi21.getCustomActions(obj);
        if (customActions != null) {
            ArrayList arrayList2 = new ArrayList(customActions.size());
            for (android.media.session.PlaybackState.CustomAction fromCustomAction : customActions) {
