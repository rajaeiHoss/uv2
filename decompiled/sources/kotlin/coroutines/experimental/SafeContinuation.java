...
public final class SafeContinuation<T> implements Continuation<T> {
    ...
    private static final AtomicReferenceFieldUpdater<SafeContinuation<?>, Object> RESULT = AtomicReferenceFieldUpdater.newUpdater(SafeContinuation.class, Object.class, Form.TYPE_RESULT);
