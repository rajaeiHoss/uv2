...
final class AdjustedTimeMark extends TimeMark {
    ...
    public double elapsedNow() {
        return Duration.m663minusLRDsOJo(this.mark.elapsedNow(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m637plusLRDsOJo(double d) {
        return new AdjustedTimeMark(this.mark, Duration.m664plusLRDsOJo(this.adjustment, d), (DefaultConstructorMarker) null);
    }
}
