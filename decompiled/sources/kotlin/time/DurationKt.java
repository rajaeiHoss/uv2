...
public final class DurationKt {
    ...
    private static final double m685timesmvk6XK0(int i, double d) {
        return Duration.m667timesimpl(d, i);
    }

    /* renamed from: times-kIfJnKk  reason: not valid java name */
    private static final double m684timeskIfJnKk(double d, double d2) {
        return Duration.m666timesimpl(d2, d);
    }

    public static final double toDuration(double d, TimeUnit timeUnit) {
        Intrinsics.checkParameterIsNotNull(timeUnit, "unit");
        return Duration.m640constructorimpl(DurationUnitKt.convertDurationUnit(d, timeUnit, TimeUnit.NANOSECONDS));
    }
}
