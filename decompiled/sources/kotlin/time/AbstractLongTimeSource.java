...
public abstract class AbstractLongTimeSource implements TimeSource {
    ...
    private static final class LongTimeMark extends TimeMark {
        ...
        public TimeMark m636plusLRDsOJo(double d) {
            return new LongTimeMark(this.startedAt, this.timeSource, Duration.m664plusLRDsOJo(this.offset, d), (DefaultConstructorMarker) null);
        }
    }
