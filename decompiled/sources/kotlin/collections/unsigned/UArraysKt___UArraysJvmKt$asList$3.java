...
public final class UArraysKt___UArraysJvmKt$asList$3 extends AbstractList<UByte> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UByte) {
            return m58contains7apg3OU(((UByte) obj).m754unboximpl());
        }
        return false;
    }
    ...
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof UByte) {
            return m59indexOf7apg3OU(((UByte) obj).m754unboximpl());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof UByte) {
            return m60lastIndexOf7apg3OU(((UByte) obj).m754unboximpl());
        }
        return -1;
    }

    public int getSize() {
        return UByteArray.m763getSizeimpl(this.$this_asList);
    }

    public boolean isEmpty() {
        return UByteArray.m765isEmptyimpl(this.$this_asList);
    }

    /* renamed from: contains-7apg3OU  reason: not valid java name */
    public boolean m58contains7apg3OU(byte b) {
        return UByteArray.m758contains7apg3OU(this.$this_asList, b);
    }

    public UByte get(int i) {
        return UByte.m707boximpl(UByteArray.m762getimpl(this.$this_asList, i));
    }

    /* renamed from: indexOf-7apg3OU  reason: not valid java name */
    public int m59indexOf7apg3OU(byte b) {
        return ArraysKt.indexOf(this.$this_asList, b);
    }

    /* renamed from: lastIndexOf-7apg3OU  reason: not valid java name */
    public int m60lastIndexOf7apg3OU(byte b) {
