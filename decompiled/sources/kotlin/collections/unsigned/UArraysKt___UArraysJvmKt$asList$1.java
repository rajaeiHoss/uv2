...
public final class UArraysKt___UArraysJvmKt$asList$1 extends AbstractList<UInt> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UInt) {
            return m52containsWZ4Q5Ns(((UInt) obj).m823unboximpl());
        }
        return false;
    }
    ...
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof UInt) {
            return m53indexOfWZ4Q5Ns(((UInt) obj).m823unboximpl());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof UInt) {
            return m54lastIndexOfWZ4Q5Ns(((UInt) obj).m823unboximpl());
        }
        return -1;
    }

    public int getSize() {
        return UIntArray.m832getSizeimpl(this.$this_asList);
    }

    public boolean isEmpty() {
        return UIntArray.m834isEmptyimpl(this.$this_asList);
    }

    /* renamed from: contains-WZ4Q5Ns  reason: not valid java name */
    public boolean m52containsWZ4Q5Ns(int i) {
        return UIntArray.m827containsWZ4Q5Ns(this.$this_asList, i);
    }

    public UInt get(int i) {
        return UInt.m774boximpl(UIntArray.m831getimpl(this.$this_asList, i));
    }

    /* renamed from: indexOf-WZ4Q5Ns  reason: not valid java name */
    public int m53indexOfWZ4Q5Ns(int i) {
        return ArraysKt.indexOf(this.$this_asList, i);
    }

    /* renamed from: lastIndexOf-WZ4Q5Ns  reason: not valid java name */
    public int m54lastIndexOfWZ4Q5Ns(int i) {
