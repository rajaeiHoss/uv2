...
public final class UArraysKt___UArraysJvmKt$asList$4 extends AbstractList<UShort> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UShort) {
            return m61containsxj2QHRw(((UShort) obj).m987unboximpl());
        }
        return false;
    }
    ...
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof UShort) {
            return m62indexOfxj2QHRw(((UShort) obj).m987unboximpl());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof UShort) {
            return m63lastIndexOfxj2QHRw(((UShort) obj).m987unboximpl());
        }
        return -1;
    }

    public int getSize() {
        return UShortArray.m996getSizeimpl(this.$this_asList);
    }

    public boolean isEmpty() {
        return UShortArray.m998isEmptyimpl(this.$this_asList);
    }

    /* renamed from: contains-xj2QHRw  reason: not valid java name */
    public boolean m61containsxj2QHRw(short s) {
        return UShortArray.m991containsxj2QHRw(this.$this_asList, s);
    }

    public UShort get(int i) {
        return UShort.m940boximpl(UShortArray.m995getimpl(this.$this_asList, i));
    }

    /* renamed from: indexOf-xj2QHRw  reason: not valid java name */
    public int m62indexOfxj2QHRw(short s) {
        return ArraysKt.indexOf(this.$this_asList, s);
    }

    /* renamed from: lastIndexOf-xj2QHRw  reason: not valid java name */
    public int m63lastIndexOfxj2QHRw(short s) {
