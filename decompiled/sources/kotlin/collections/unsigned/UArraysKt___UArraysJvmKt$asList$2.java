...
public final class UArraysKt___UArraysJvmKt$asList$2 extends AbstractList<ULong> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof ULong) {
            return m55containsVKZWuLQ(((ULong) obj).m892unboximpl());
        }
        return false;
    }
    ...
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof ULong) {
            return m56indexOfVKZWuLQ(((ULong) obj).m892unboximpl());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof ULong) {
            return m57lastIndexOfVKZWuLQ(((ULong) obj).m892unboximpl());
        }
        return -1;
    }

    public int getSize() {
        return ULongArray.m901getSizeimpl(this.$this_asList);
    }

    public boolean isEmpty() {
        return ULongArray.m903isEmptyimpl(this.$this_asList);
    }

    /* renamed from: contains-VKZWuLQ  reason: not valid java name */
    public boolean m55containsVKZWuLQ(long j) {
        return ULongArray.m896containsVKZWuLQ(this.$this_asList, j);
    }

    public ULong get(int i) {
        return ULong.m843boximpl(ULongArray.m900getimpl(this.$this_asList, i));
    }

    /* renamed from: indexOf-VKZWuLQ  reason: not valid java name */
    public int m56indexOfVKZWuLQ(long j) {
        return ArraysKt.indexOf(this.$this_asList, j);
    }

    /* renamed from: lastIndexOf-VKZWuLQ  reason: not valid java name */
    public int m57lastIndexOfVKZWuLQ(long j) {
