...
public final class UArraysKt {
    ...
    public static final int m28random2D5oskM(int[] iArr, Random random) {
        Intrinsics.checkParameterIsNotNull(iArr, "$this$random");
        Intrinsics.checkParameterIsNotNull(random, "random");
        if (!UIntArray.m834isEmptyimpl(iArr)) {
            return UIntArray.m831getimpl(iArr, random.nextInt(UIntArray.m832getSizeimpl(iArr)));
        }
    ...
    public static final long m29randomJzugnMA(long[] jArr, Random random) {
        Intrinsics.checkParameterIsNotNull(jArr, "$this$random");
        Intrinsics.checkParameterIsNotNull(random, "random");
        if (!ULongArray.m903isEmptyimpl(jArr)) {
            return ULongArray.m900getimpl(jArr, random.nextInt(ULongArray.m901getSizeimpl(jArr)));
        }
        throw new NoSuchElementException("Array is empty.");
    }
    ...
    public static final byte m30randomoSF2wD8(byte[] bArr, Random random) {
        Intrinsics.checkParameterIsNotNull(bArr, "$this$random");
        Intrinsics.checkParameterIsNotNull(random, "random");
        if (!UByteArray.m765isEmptyimpl(bArr)) {
            return UByteArray.m762getimpl(bArr, random.nextInt(UByteArray.m763getSizeimpl(bArr)));
        }
        throw new NoSuchElementException("Array is empty.");
    }
    ...
    public static final short m31randoms5X_as8(short[] sArr, Random random) {
        Intrinsics.checkParameterIsNotNull(sArr, "$this$random");
        Intrinsics.checkParameterIsNotNull(random, "random");
        if (!UShortArray.m998isEmptyimpl(sArr)) {
            return UShortArray.m995getimpl(sArr, random.nextInt(UShortArray.m996getSizeimpl(sArr)));
        }
        throw new NoSuchElementException("Array is empty.");
    }
    ...
    public static final boolean m16contentEqualsctEhBpI(int[] iArr, int[] iArr2) {
    ...
    public static final boolean m19contentEqualsus8wMrg(long[] jArr, long[] jArr2) {
    ...
    public static final boolean m17contentEqualskdPth3s(byte[] bArr, byte[] bArr2) {
    ...
    public static final boolean m18contentEqualsmazbYpA(short[] sArr, short[] sArr2) {
    ...
    public static final int m20contentHashCodeajY9A(int[] iArr) {
    ...
    public static final int m22contentHashCodeQwZRm1k(long[] jArr) {
    ...
    public static final int m21contentHashCodeGBYM_sE(byte[] bArr) {
    ...
    public static final int m23contentHashCoderL5Bavg(short[] sArr) {
    ...
    public static final String m24contentToStringajY9A(int[] iArr) {
    ...
    public static final String m26contentToStringQwZRm1k(long[] jArr) {
    ...
    public static final String m25contentToStringGBYM_sE(byte[] bArr) {
    ...
    public static final String m27contentToStringrL5Bavg(short[] sArr) {
    ...
    public static final UInt[] m32toTypedArrayajY9A(int[] iArr) {
        Intrinsics.checkParameterIsNotNull(iArr, "$this$toTypedArray");
        int r0 = UIntArray.m832getSizeimpl(iArr);
        UInt[] uIntArr = new UInt[r0];
        for (int i = 0; i < r0; i++) {
            uIntArr[i] = UInt.m774boximpl(UIntArray.m831getimpl(iArr, i));
        }
        return uIntArr;
    }
    ...
    public static final ULong[] m34toTypedArrayQwZRm1k(long[] jArr) {
        Intrinsics.checkParameterIsNotNull(jArr, "$this$toTypedArray");
        int r0 = ULongArray.m901getSizeimpl(jArr);
        ULong[] uLongArr = new ULong[r0];
        for (int i = 0; i < r0; i++) {
            uLongArr[i] = ULong.m843boximpl(ULongArray.m900getimpl(jArr, i));
        }
        return uLongArr;
    }
    ...
    public static final UByte[] m33toTypedArrayGBYM_sE(byte[] bArr) {
        Intrinsics.checkParameterIsNotNull(bArr, "$this$toTypedArray");
        int r0 = UByteArray.m763getSizeimpl(bArr);
        UByte[] uByteArr = new UByte[r0];
        for (int i = 0; i < r0; i++) {
            uByteArr[i] = UByte.m707boximpl(UByteArray.m762getimpl(bArr, i));
        }
        return uByteArr;
    }
    ...
    public static final UShort[] m35toTypedArrayrL5Bavg(short[] sArr) {
        Intrinsics.checkParameterIsNotNull(sArr, "$this$toTypedArray");
        int r0 = UShortArray.m996getSizeimpl(sArr);
        UShort[] uShortArr = new UShort[r0];
        for (int i = 0; i < r0; i++) {
            uShortArr[i] = UShort.m940boximpl(UShortArray.m995getimpl(sArr, i));
        }
        return uShortArr;
    }
}
