...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> collection) {
        ...
        byte[] r0 = UByteArray.m756constructorimpl(collection.size());
        int i = 0;
        for (UByte r2 : collection) {
            UByteArray.m767setVurrAj0(r0, i, r2.m754unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int[] toUIntArray(Collection<UInt> collection) {
        ...
        int[] r0 = UIntArray.m825constructorimpl(collection.size());
        int i = 0;
        for (UInt r2 : collection) {
            UIntArray.m836setVXSXFK8(r0, i, r2.m823unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final long[] toULongArray(Collection<ULong> collection) {
        ...
        long[] r0 = ULongArray.m894constructorimpl(collection.size());
        int i = 0;
        for (ULong r2 : collection) {
            ULongArray.m905setk8EXiF4(r0, i, r2.m892unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> collection) {
        ...
        short[] r0 = UShortArray.m989constructorimpl(collection.size());
        int i = 0;
        for (UShort r2 : collection) {
            UShortArray.m1000set01HTLdE(r0, i, r2.m987unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int sumOfUInt(Iterable<UInt> iterable) {
        ...
        for (UInt r1 : iterable) {
            i = UInt.m780constructorimpl(i + r1.m823unboximpl());
        }
        return i;
    }
    ...
    public static final long sumOfULong(Iterable<ULong> iterable) {
        ...
        for (ULong r2 : iterable) {
            j = ULong.m849constructorimpl(j + r2.m892unboximpl());
        }
        return j;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> iterable) {
        ...
        for (UByte r1 : iterable) {
            i = UInt.m780constructorimpl(i + UInt.m780constructorimpl(r1.m754unboximpl() & UByte.MAX_VALUE));
        }
        return i;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> iterable) {
        ...
        for (UShort r1 : iterable) {
            i = UInt.m780constructorimpl(i + UInt.m780constructorimpl(r1.m987unboximpl() & UShort.MAX_VALUE));
        }
        return i;
    }
}
