...
public final class UIntRange extends UIntProgression implements ClosedRange<UInt> {
    ...
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m594containsWZ4Q5Ns(((UInt) comparable).m823unboximpl());
    }

    public UInt getStart() {
        return UInt.m774boximpl(getFirst());
    }

    public UInt getEndInclusive() {
        return UInt.m774boximpl(getLast());
    }

    /* renamed from: contains-WZ4Q5Ns  reason: not valid java name */
    public boolean m594containsWZ4Q5Ns(int i) {
    ...
    public String toString() {
        return UInt.m817toStringimpl(getFirst()) + ".." + UInt.m817toStringimpl(getLast());
    }
