...
class DigestChallenge {
    ...
    public void checkSemantics(DirectiveList directiveList) throws SaslException {
        ...
        } else if ((i & 4) == 4 && (this.m_cipherOptions & 31) == 0) {
    ...
    /* access modifiers changed from: package-private */
    public void handleNonce(ParsedDirective parsedDirective) throws SaslException {
    ...
    /* access modifiers changed from: package-private */
    public void handleRealm(ParsedDirective parsedDirective) {
        this.m_realms.add(parsedDirective.getValue());
    }

    /* access modifiers changed from: package-private */
    public void handleQop(ParsedDirective parsedDirective) throws SaslException {
        if (this.m_qop == 0) {
    ...
    /* access modifiers changed from: package-private */
    public void handleMaxbuf(ParsedDirective parsedDirective) throws SaslException {
        if (-1 == this.m_maxBuf) {
            int parseInt = Integer.parseInt(parsedDirective.getValue());
            this.m_maxBuf = parseInt;
            if (parseInt == 0) {
    ...
    /* access modifiers changed from: package-private */
    public void handleCharset(ParsedDirective parsedDirective) throws SaslException {
        if (this.m_characterSet == null) {
            String value = parsedDirective.getValue();
            this.m_characterSet = value;
    ...
    /* access modifiers changed from: package-private */
    public void handleAlgorithm(ParsedDirective parsedDirective) throws SaslException {
        if (this.m_algorithm == null) {
            String value = parsedDirective.getValue();
            this.m_algorithm = value;
            if (!"md5-sess".equals(value)) {
    ...
    /* access modifiers changed from: package-private */
    public void handleCipher(ParsedDirective parsedDirective) throws SaslException {
    ...
    /* access modifiers changed from: package-private */
    public void handleStale(ParsedDirective parsedDirective) throws SaslException {
        if (this.m_staleFlag) {
