...
class IntKeyframeSet extends KeyframeSet {
    ...
    public int getIntValue(float f) {
        if (this.mNumKeyframes == 2) {
            ...
            return this.mEvaluator == null ? intValue2 + ((int) (f2 * ((float) (intValue3 - intValue2)))) : ((Number) this.mEvaluator.evaluate(f2, Integer.valueOf(intValue2), Integer.valueOf(intValue3))).intValue();
        } else if (f >= 1.0f) {
            ...
            return this.mEvaluator == null ? intValue4 + ((int) (f3 * ((float) (intValue5 - intValue4)))) : ((Number) this.mEvaluator.evaluate(f3, Integer.valueOf(intValue4), Integer.valueOf(intValue5))).intValue();
        } else {
            ...
            while (i < this.mNumKeyframes) {
                ...
                if (f < intKeyframe6.getFraction()) {
                    ...
                    return this.mEvaluator == null ? intValue6 + ((int) (fraction5 * ((float) (intValue7 - intValue6)))) : ((Number) this.mEvaluator.evaluate(fraction5, Integer.valueOf(intValue6), Integer.valueOf(intValue7))).intValue();
                }
                i++;
