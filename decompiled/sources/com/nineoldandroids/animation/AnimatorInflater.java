...
public class AnimatorInflater {
    private static final int[] Animator = {16843160, 16843198, 16843488, 16843486, 16843487, 16843199, 16843200, 16843073};
            ...
            if ((next != 3 || xmlPullParser.getDepth() > depth) && next != 1) {
                if (next == 2) {
                    ...
                    if (name.equals("objectAnimator")) {
                        ...
                        createAnimatorFromXml(context, xmlPullParser, attributeSet, (AnimatorSet) animator, obtainStyledAttributes.getInt(0, 0));
    ...
    private static ValueAnimator loadAnimator(Context context, AttributeSet attributeSet, ValueAnimator valueAnimator) throws Resources.NotFoundException {
        ...
        long j = (long) obtainStyledAttributes.getInt(0, 0);
        long j2 = (long) obtainStyledAttributes.getInt(1, 0);
        ...
        if (z) {
            if (z2) {
                ...
                if (z3) {
                    if (i7 == 5) {
                        ...
                        f3 = obtainStyledAttributes.getFloat(4, 0.0f);
                    }
                ...
                if (i7 == 5) {
                    ...
                    f = obtainStyledAttributes.getFloat(4, 0.0f);
                }
            ...
            if (z2) {
                ...
                if (z3) {
                    if (i7 == 5) {
                        i4 = (int) obtainStyledAttributes.getDimension(4, 0.0f);
                    } else if (i7 < 28 || i7 > 31) {
        ...
        if (obtainStyledAttributes.hasValue(5)) {
            valueAnimator2.setRepeatCount(obtainStyledAttributes.getInt(5, i));
        }
        if (obtainStyledAttributes.hasValue(6)) {
            valueAnimator2.setRepeatMode(obtainStyledAttributes.getInt(6, 1));
        }
