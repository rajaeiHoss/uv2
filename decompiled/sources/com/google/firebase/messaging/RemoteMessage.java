...
public final class RemoteMessage extends zzbgl {
    ...
    public static class Builder {
        ...
        public RemoteMessage build() {
            ...
            this.mBundle.remove(PrivacyItem.PrivacyRule.SUBSCRIPTION_FROM);
        ...
        if (this.zzdvf == null) {
            ...
            for (String str : this.mBundle.keySet()) {
                ...
                if (obj instanceof String) {
                    ...
                    if (!str.startsWith("google.") && !str.startsWith("gcm.") && !str.equals(PrivacyItem.PrivacyRule.SUBSCRIPTION_FROM) && !str.equals("message_type") && !str.equals("collapse_key")) {
                        this.zzdvf.put(str, str2);
                    }
                }
            }
