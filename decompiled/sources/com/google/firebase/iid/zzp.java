...
final /* synthetic */ class zzp implements Runnable {
    ...
    public final void run() {
        ...
        L_0x0002:
            ...
            return
        L_0x000a:
            java.util.Queue<com.google.firebase.iid.zzt<?>> r1 = r0.zzini     // Catch:{ all -> 0x00ae }
            boolean r1 = r1.isEmpty()     // Catch:{ all -> 0x00ae }
            if (r1 == 0) goto L_0x0017
            r0.zzawu()     // Catch:{ all -> 0x00ae }
            monitor-exit(r0)     // Catch:{ all -> 0x00ae }
            return
        L_0x0017:
            java.util.Queue<com.google.firebase.iid.zzt<?>> r1 = r0.zzini     // Catch:{ all -> 0x00ae }
            java.lang.Object r1 = r1.poll()     // Catch:{ all -> 0x00ae }
            com.google.firebase.iid.zzt r1 = (com.google.firebase.iid.zzt) r1     // Catch:{ all -> 0x00ae }
            android.util.SparseArray<com.google.firebase.iid.zzt<?>> r3 = r0.zzinj     // Catch:{ all -> 0x00ae }
            int r4 = r1.zzino     // Catch:{ all -> 0x00ae }
            r3.put(r4, r1)     // Catch:{ all -> 0x00ae }
            com.google.firebase.iid.zzk r3 = r0.zzokz     // Catch:{ all -> 0x00ae }
            java.util.concurrent.ScheduledExecutorService r3 = r3.zzind     // Catch:{ all -> 0x00ae }
            com.google.firebase.iid.zzq r4 = new com.google.firebase.iid.zzq     // Catch:{ all -> 0x00ae }
        ...
        L_0x0066:
            ...
            r4.putBundle(r3, r1)
            r5.setData(r4)
            com.google.firebase.iid.zzr r1 = r0.zzoky     // Catch:{ RemoteException -> 0x00a4 }
