...
final class zzaa {
    ...
    public final synchronized java.lang.String zzcls() {
        /*
            r4 = this;
            monitor-enter(r4)
            android.content.SharedPreferences r0 = r4.zzioc     // Catch:{ all -> 0x0024 }
    ...
    public final synchronized java.security.KeyPair zzrs(java.lang.String r5) {
        /*
            r4 = this;
            monitor-enter(r4)
            android.content.SharedPreferences r0 = r4.zzioc     // Catch:{ all -> 0x007c }
            java.lang.String r1 = "|P|"
            java.lang.String r1 = zzbk(r5, r1)     // Catch:{ all -> 0x007c }
            r2 = 0
            java.lang.String r0 = r0.getString(r1, r2)     // Catch:{ all -> 0x007c }
            android.content.SharedPreferences r1 = r4.zzioc     // Catch:{ all -> 0x007c }
            java.lang.String r3 = "|K|"
            java.lang.String r5 = zzbk(r5, r3)     // Catch:{ all -> 0x007c }
            java.lang.String r5 = r1.getString(r5, r2)     // Catch:{ all -> 0x007c }
            if (r0 == 0) goto L_0x007a
            if (r5 != 0) goto L_0x0021
            goto L_0x007a
        L_0x0021:
            r1 = 8
            byte[] r0 = android.util.Base64.decode(r0, r1)     // Catch:{ InvalidKeySpecException -> 0x004c, NoSuchAlgorithmException -> 0x004a }
            byte[] r5 = android.util.Base64.decode(r5, r1)     // Catch:{ InvalidKeySpecException -> 0x004c, NoSuchAlgorithmException -> 0x004a }
            java.lang.String r1 = "RSA"
            java.security.KeyFactory r1 = java.security.KeyFactory.getInstance(r1)     // Catch:{ InvalidKeySpecException -> 0x004c, NoSuchAlgorithmException -> 0x004a }
            java.security.spec.X509EncodedKeySpec r3 = new java.security.spec.X509EncodedKeySpec     // Catch:{ InvalidKeySpecException -> 0x004c, NoSuchAlgorithmException -> 0x004a }
            r3.<init>(r0)     // Catch:{ InvalidKeySpecException -> 0x004c, NoSuchAlgorithmException -> 0x004a }
            java.security.PublicKey r0 = r1.generatePublic(r3)     // Catch:{ InvalidKeySpecException -> 0x004c, NoSuchAlgorithmException -> 0x004a }
            java.security.spec.PKCS8EncodedKeySpec r3 = new java.security.spec.PKCS8EncodedKeySpec     // Catch:{ InvalidKeySpecException -> 0x004c, NoSuchAlgorithmException -> 0x004a }
            r3.<init>(r5)     // Catch:{ InvalidKeySpecException -> 0x004c, NoSuchAlgorithmException -> 0x004a }
            java.security.PrivateKey r5 = r1.generatePrivate(r3)     // Catch:{ InvalidKeySpecException -> 0x004c, NoSuchAlgorithmException -> 0x004a }
            java.security.KeyPair r1 = new java.security.KeyPair     // Catch:{ InvalidKeySpecException -> 0x004c, NoSuchAlgorithmException -> 0x004a }
            r1.<init>(r0, r5)     // Catch:{ InvalidKeySpecException -> 0x004c, NoSuchAlgorithmException -> 0x004a }
            monitor-exit(r4)
            return r1
        L_0x004a:
            r5 = move-exception
        ...
        L_0x004d:
            ...
            java.lang.String r5 = java.lang.String.valueOf(r5)     // Catch:{ all -> 0x007c }
            java.lang.String r1 = java.lang.String.valueOf(r5)     // Catch:{ all -> 0x007c }
            int r1 = r1.length()     // Catch:{ all -> 0x007c }
            int r1 = r1 + 19
            ...
            r3.append(r1)     // Catch:{ all -> 0x007c }
            r3.append(r5)     // Catch:{ all -> 0x007c }
            java.lang.String r5 = r3.toString()     // Catch:{ all -> 0x007c }
            android.util.Log.w(r0, r5)     // Catch:{ all -> 0x007c }
            com.google.firebase.iid.FirebaseInstanceId r5 = com.google.firebase.iid.FirebaseInstanceId.getInstance()     // Catch:{ all -> 0x007c }
            r5.zzclg()     // Catch:{ all -> 0x007c }
            monitor-exit(r4)
            return r2
        L_0x007a:
            monitor-exit(r4)
