...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
        ...
        public void onViewReleased(View view, float f, float f2) {
            ...
            if (f2 < 0.0f) {
                if (BottomSheetBehavior.this.fitToContents) {
                    targetTop = BottomSheetBehavior.this.fitToContentsOffset;
                    targetState = 3;
                } else if (view.getTop() > BottomSheetBehavior.this.halfExpandedOffset) {
                    targetTop = BottomSheetBehavior.this.halfExpandedOffset;
                    targetState = 6;
                } else {
                    targetTop = BottomSheetBehavior.this.getExpandedOffset();
                    targetState = 3;
                }
                ...
                if ((Math.abs(f) < Math.abs(f2) && f2 > 500.0f) || releasedLow(view)) {
                    targetTop = BottomSheetBehavior.this.parentHeight;
                    targetState = 5;
                ...
                if (BottomSheetBehavior.this.fitToContents) {
                    if (Math.abs(top - BottomSheetBehavior.this.fitToContentsOffset) < Math.abs(top - BottomSheetBehavior.this.collapsedOffset)) {
                        ...
                        targetTop = BottomSheetBehavior.this.collapsedOffset;
                        targetState = 4;
                    }
            ...
            BottomSheetBehavior.this.startSettlingAnimation(view, targetState, targetTop, true);
        }
    ...
    public void onStopNestedScroll(CoordinatorLayout coordinatorLayout, V v, View view, int i) {
        ...
        if (weakReference != null && view == weakReference.get() && this.nestedScrolled) {
            ...
            startSettlingAnimation(v, targetState, targetTop, false);
            this.nestedScrolled = false;
        }
    }
    ...
    private void updateAccessibilityActions() {
        ...
        if (weakReference != null && (view = (View) weakReference.get()) != null) {
            ...
            if (!this.fitToContents && this.state != 6) {
                this.expandHalfwayActionId = addAccessibilityActionForState(sheetView, R.string.bottomsheet_action_expand_halfway, 6);
            }
            if (this.hideable && this.state != 5) {
                replaceAccessibilityActionForState(sheetView, AccessibilityNodeInfoCompat.AccessibilityActionCompat.ACTION_DISMISS, 5);
            }
            int i3 = this.state;
            if (i3 == 3) {
                if (this.fitToContents) {
                ...
                replaceAccessibilityActionForState(sheetView, AccessibilityNodeInfoCompat.AccessibilityActionCompat.ACTION_COLLAPSE, i2);
            } else if (i3 == 4) {
                if (this.fitToContents) {
                    i2 = 3;
                }
                replaceAccessibilityActionForState(sheetView, AccessibilityNodeInfoCompat.AccessibilityActionCompat.ACTION_EXPAND, i2);
            } else if (i3 == 6) {
                replaceAccessibilityActionForState(sheetView, AccessibilityNodeInfoCompat.AccessibilityActionCompat.ACTION_COLLAPSE, 4);
                replaceAccessibilityActionForState(sheetView, AccessibilityNodeInfoCompat.AccessibilityActionCompat.ACTION_EXPAND, 3);
            }
        }
    }
