...
public class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    private void buildShadowCorners() {
        ...
        if (f3 > 0.0f) {
            ...
            RadialGradient radialGradient = new RadialGradient(0.0f, 0.0f, f3, new int[]{0, this.shadowStartColor, this.shadowMiddleColor, this.shadowEndColor}, new float[]{0.0f, f4, ((1.0f - f4) / 2.0f) + f4, 1.0f}, Shader.TileMode.CLAMP);
