...
public final class zzciz {
    ...
    public static zzcja<Long> zzjio = zzcja.zzb("measurement.ad_id_cache_time", (long) NotificationOptions.SKIP_STEP_TEN_SECONDS_IN_MS, (long) NotificationOptions.SKIP_STEP_TEN_SECONDS_IN_MS);
    ...
    public static zzcja<String> zzjir = zzcja.zzj("measurement.config.url_scheme", "https", "https");
    public static zzcja<String> zzjis = zzcja.zzj("measurement.config.url_authority", "app-measurement.com", "app-measurement.com");
    ...
    public static zzcja<String> zzjjd = zzcja.zzj("measurement.upload.url", "https://app-measurement.com/a", "https://app-measurement.com/a");
    ...
    public static zzcja<Long> zzjjh = zzcja.zzb("measurement.upload.realtime_upload_interval", (long) NotificationOptions.SKIP_STEP_TEN_SECONDS_IN_MS, (long) NotificationOptions.SKIP_STEP_TEN_SECONDS_IN_MS);
