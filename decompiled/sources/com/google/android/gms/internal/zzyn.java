...
public class zzyn {
    ...
    public final void zzb(int i, int i2, int i3, int i4) {
        try {
            this.zzcct.zza("onSizeChanged", new JSONObject().put(GroupChatInvitation.ELEMENT_NAME, i).put("y", i2).put("width", i3).put("height", i4));
        } catch (JSONException e) {
    ...
    public final void zzbm(String str) {
        try {
            this.zzcct.zza("onError", new JSONObject().put(CommonUtilities.EXTRA_MESSAGE, str).put("action", this.zzcmf));
        } catch (JSONException e) {
    ...
    public final void zzc(int i, int i2, int i3, int i4) {
        try {
            this.zzcct.zza("onDefaultPositionReceived", new JSONObject().put(GroupChatInvitation.ELEMENT_NAME, i).put("y", i2).put("width", i3).put("height", i4));
        } catch (JSONException e) {
