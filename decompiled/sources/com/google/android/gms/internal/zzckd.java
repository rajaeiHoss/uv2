        ...
        if (!(zzcny == null || zzcny.zzjua == null)) {
            for (zzcnx zzcnx : zzcny.zzjua) {
                if (TextUtils.isEmpty(zzcnx.name)) {
                    ...
                    String zzix = AppMeasurement.Event.zzix(zzcnx.name);
    ...
    public final boolean zzb(String str, byte[] bArr, String str2) {
        ...
        for (zzcnr zzcnr : zzcnrArr) {
            for (zzcns zzcns : zzcnr.zzjsv) {
                String zzix = AppMeasurement.Event.zzix(zzcns.zzjsy);
                if (zzix != null) {
                    zzcns.zzjsy = zzix;
                }
                for (zzcnt zzcnt : zzcns.zzjsz) {
                    String zzix2 = AppMeasurement.Param.zzix(zzcnt.zzjtg);
                    if (zzix2 != null) {
                        zzcnt.zzjtg = zzix2;
                    }
                }
            ...
            for (zzcnv zzcnv : zzcnr.zzjsu) {
                String zzix3 = AppMeasurement.UserProperty.zzix(zzcnv.zzjtn);
                if (zzix3 != null) {
                    zzcnv.zzjtn = zzix3;
                }
            }
        ...
        try {
            ...
            int zzhs = zzc.zzhs();
            bArr2 = new byte[zzhs];
            zzc.zza(zzflk.zzp(bArr2, 0, zzhs));
        } catch (IOException e) {
