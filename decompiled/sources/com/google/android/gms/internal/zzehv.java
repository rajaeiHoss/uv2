...
final class zzehv implements zzefo {
    ...
    zzehv(zzegx zzegx, zzegu zzegu, long j, DatabaseReference.CompletionListener completionListener) {
        this.zznfo = zzegx;
        this.zzneb = zzegu;
        this.zzngk = j;
    ...
    public final void zzbc(String str, String str2) {
        ...
        this.zznfo.zza("setValue", this.zzneb, zzbe);
