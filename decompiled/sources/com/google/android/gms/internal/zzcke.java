...
public final class zzcke extends zzcli {
    ...
    /* access modifiers changed from: private */
    public final Object zzjnh = new Object();
    /* access modifiers changed from: private */
    public final Semaphore zzjni = new Semaphore(2);
    /* access modifiers changed from: private */
    public volatile boolean zzjnj;
    ...
    private final void zza(zzckh<?> zzckh) {
        synchronized (this.zzjnh) {
            ...
            zzcki zzcki = this.zzjnb;
            if (zzcki == null) {
                zzcki zzcki2 = new zzcki(this, "Measurement Worker", this.zzjnd);
                this.zzjnb = zzcki2;
                zzcki2.setUncaughtExceptionHandler(this.zzjnf);
                this.zzjnb.start();
            } else {
                zzcki.zzsl();
            }
    ...
    public final <V> Future<V> zzc(Callable<V> callable) throws IllegalStateException {
        ...
        zzckh zzckh = new zzckh(this, callable, false, "Task exception on worker thread");
    ...
    public final <V> Future<V> zzd(Callable<V> callable) throws IllegalStateException {
        zzyk();
        zzbq.checkNotNull(callable);
        zzckh zzckh = new zzckh(this, callable, true, "Task exception on worker thread");
        if (Thread.currentThread() == this.zzjnb) {
            zzckh.run();
        } else {
            zza((zzckh<?>) zzckh);
    ...
    public final void zzh(Runnable runnable) throws IllegalStateException {
        ...
        zza((zzckh<?>) new zzckh(this, runnable, false, "Task exception on worker thread"));
    }
    ...
    public final void zzi(Runnable runnable) throws IllegalStateException {
        ...
        synchronized (this.zzjnh) {
            ...
            zzcki zzcki = this.zzjnc;
            if (zzcki == null) {
                zzcki zzcki2 = new zzcki(this, "Measurement Network", this.zzjne);
                this.zzjnc = zzcki2;
                zzcki2.setUncaughtExceptionHandler(this.zzjng);
                this.zzjnc.start();
            } else {
                zzcki.zzsl();
            }
