...
public final class zzdxs {
        ...
        if (zza.signum() == 1) {
            ...
            if (mod2.equals(BigInteger.ZERO)) {
                ...
                if (zza.testBit(0) && zza.testBit(1)) {
                    ...
                    throw new InvalidAlgorithmParameterException("p must be prime");
                }
            ...
            return true != bigInteger2.testBit(0) ? zza.subtract(bigInteger2).mod(zza) : bigInteger2;
        }
    ...
    public static KeyPair zza(ECParameterSpec eCParameterSpec) throws GeneralSecurityException {
        KeyPairGenerator zzoy = zzdxx.zzmlp.zzoy("EC");
        zzoy.initialize(eCParameterSpec);
        return zzoy.generateKeyPair();
    }

    public static ECPublicKey zza(zzdxu zzdxu, byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        ECParameterSpec zza = zza(zzdxu);
        ECPoint eCPoint = new ECPoint(new BigInteger(1, bArr), new BigInteger(1, bArr2));
        zza(eCPoint, zza.getCurve());
        return (ECPublicKey) zzdxx.zzmlq.zzoy("EC").generatePublic(new ECPublicKeySpec(eCPoint, zza));
    }

    public static ECParameterSpec zza(zzdxu zzdxu) throws NoSuchAlgorithmException {
        String str;
        String str2;
        String str3;
        String str4;
        ...
        if (i == 1) {
            ...
            String valueOf = String.valueOf(zzdxu);
    ...
    public static byte[] zza(ECPrivateKey eCPrivateKey, ECPoint eCPoint) throws GeneralSecurityException {
        ...
        KeyAgreement zzoy = zzdxx.zzmlo.zzoy("ECDH");
        zzoy.init(eCPrivateKey);
        zzoy.doPhase(generatePublic, true);
        byte[] generateSecret = zzoy.generateSecret();
