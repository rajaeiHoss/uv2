...
public final class zzcha {
    ...
    private final zzchf zzm(zzci<LocationListener> zzci) {
        ...
        synchronized (this.zziue) {
            zzchf = this.zziue.get(zzci.zzakx());
            if (zzchf == null) {
    ...
    private final zzchb zzn(zzci<LocationCallback> zzci) {
        ...
        synchronized (this.zziug) {
            zzchb = this.zziug.get(zzci.zzakx());
            if (zzchb == null) {
    ...
    public final void removeAllListeners() throws RemoteException {
        synchronized (this.zziue) {
            for (zzchf next : this.zziue.values()) {
                if (next != null) {
                    this.zzitk.zzalw().zza(zzchn.zza((zzx) next, (zzcgr) null));
                }
            }
            this.zziue.clear();
        }
        synchronized (this.zziug) {
            for (zzchb next2 : this.zziug.values()) {
                if (next2 != null) {
                    this.zzitk.zzalw().zza(zzchn.zza((zzu) next2, (zzcgr) null));
                }
            }
            this.zziug.clear();
        }
        synchronized (this.zziuf) {
            for (zzche next3 : this.zziuf.values()) {
                if (next3 != null) {
                    this.zzitk.zzalw().zza(new zzcfw(2, (zzcfu) null, next3.asBinder(), (IBinder) null));
                }
            }
            this.zziuf.clear();
        }
    ...
    public final void zza(PendingIntent pendingIntent, zzcgr zzcgr) throws RemoteException {
        this.zzitk.zzalv();
        this.zzitk.zzalw().zza(new zzchn(2, (zzchl) null, (IBinder) null, pendingIntent, (IBinder) null, zzcgr != null ? zzcgr.asBinder() : null));
    }
    ...
    public final void zza(zzck<LocationListener> zzck, zzcgr zzcgr) throws RemoteException {
        ...
        synchronized (this.zziue) {
            zzchf remove = this.zziue.remove(zzck);
            if (remove != null) {
                remove.release();
                this.zzitk.zzalw().zza(zzchn.zza((zzx) remove, zzcgr));
            }
        }
    }
    ...
    public final void zza(zzcgr zzcgr) throws RemoteException {
        this.zzitk.zzalv();
        this.zzitk.zzalw().zza(zzcgr);
    }

    public final void zza(zzchl zzchl, zzci<LocationCallback> zzci, zzcgr zzcgr) throws RemoteException {
        this.zzitk.zzalv();
        this.zzitk.zzalw().zza(new zzchn(1, zzchl, (IBinder) null, (PendingIntent) null, zzn(zzci).asBinder(), zzcgr != null ? zzcgr.asBinder() : null));
    }

    public final void zza(LocationRequest locationRequest, PendingIntent pendingIntent, zzcgr zzcgr) throws RemoteException {
        this.zzitk.zzalv();
        this.zzitk.zzalw().zza(new zzchn(1, zzchl.zza(locationRequest), (IBinder) null, pendingIntent, (IBinder) null, zzcgr != null ? zzcgr.asBinder() : null));
    }

    public final void zza(LocationRequest locationRequest, zzci<LocationListener> zzci, zzcgr zzcgr) throws RemoteException {
        this.zzitk.zzalv();
        this.zzitk.zzalw().zza(new zzchn(1, zzchl.zza(locationRequest), zzm(zzci).asBinder(), (PendingIntent) null, (IBinder) null, zzcgr != null ? zzcgr.asBinder() : null));
    }
    ...
    public final void zzb(zzck<LocationCallback> zzck, zzcgr zzcgr) throws RemoteException {
        ...
        zzbq.checkNotNull(zzck, "Invalid null listener key");
        synchronized (this.zziug) {
            zzchb remove = this.zziug.remove(zzck);
            if (remove != null) {
                remove.release();
                this.zzitk.zzalw().zza(zzchn.zza((zzu) remove, zzcgr));
            }
        }
    }
