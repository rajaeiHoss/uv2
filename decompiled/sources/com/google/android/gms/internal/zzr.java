...
public abstract class zzr<T> implements Comparable<zzr<T>> {
    ...
    public zzr(int i, String str, zzy zzy) {
        Uri parse;
        String host;
        this.zzae = com.google.android.gms.internal.zzaf.zza.zzbk ? new com.google.android.gms.internal.zzaf.zza() : null;
    ...
    public final int compareTo(zzr<T> zzr) {
        zzu priority = zzu.NORMAL;
        zzu other = zzu.NORMAL;
        return priority == other ? this.zzaj.intValue() - zzr.zzaj.intValue() : other.ordinal() - priority.ordinal();
    }
