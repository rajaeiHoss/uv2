...
public final class zzbzw implements BleApi {
    ...
    public final PendingResult<Status> unclaimBleDevice(GoogleApiClient googleApiClient, String str) {
        return googleApiClient.zze(new zzcab(this, googleApiClient, str));
    }
}
