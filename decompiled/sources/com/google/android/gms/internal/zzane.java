...
public final class zzane {
    ...
    public zzane(Context context, ViewGroup viewGroup, zzaof zzaof) {
        this(context, viewGroup, zzaof, (zzanb) null);
    }
    ...
    public final void zza(int i, int i2, int i3, int i4, int i5, boolean z, zzanm zzanm) {
        if (this.zzdma == null) {
            ...
            zzanb zzanb = new zzanb(context, zzann, i5, z, zzann.zztk().zzjn(), zzanm);
            this.zzdma = zzanb;
            this.zzdlz.addView(zzanb, 0, new ViewGroup.LayoutParams(-1, -1));
            int i6 = i;
            int i7 = i2;
            int i8 = i3;
            int i9 = i4;
