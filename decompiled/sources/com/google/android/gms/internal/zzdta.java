...
public final class zzdta {
    public static zzdwn zza(String str, String str2, String str3, int i, boolean z) {
        ...
        return (zzdwn) zzos.zzot(valueOf.length() != 0 ? "type.googleapis.com/google.crypto.tink.".concat(valueOf) : new String("type.googleapis.com/google.crypto.tink.")).zzgq(0).zzch(true).zzou(str).zzczx();
    }
}
