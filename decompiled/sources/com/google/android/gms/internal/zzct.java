...
public class zzct extends zzcs {
    private static final String TAG = "zzct";
    ...
    private static zzdr zza(zzdm zzdm, MotionEvent motionEvent, DisplayMetrics displayMetrics) throws zzdj {
        ...
        try {
            return new zzdr((String) zza.invoke((Object) null, new Object[]{motionEvent, displayMetrics}));
    ...
    private static void zzb(List<Callable<Void>> list) {
        ...
        if (zzagq != null && (executorService = zzagq.getExecutorService()) != null && !list.isEmpty()) {
            try {
    ...
    public final long zza(StackTraceElement[] stackTraceElementArr) throws zzdj {
        ...
        try {
            return new zzdk((String) zza.invoke((Object) null, new Object[]{stackTraceElementArr})).zzail.longValue();
        } catch (IllegalAccessException | InvocationTargetException e) {
            throw new zzdj(e);
        }
    }
    ...
    public final zzba zza(Context context, View view, Activity activity) {
        ...
        if (!zzb.isInitialized()) {
            zzba.zzds = Long.valueOf(PlaybackStateCompat.ACTION_PREPARE);
            list = Arrays.asList(new Callable[]{new zzef(zzb, zzba)});
        } else {
            try {
            ...
            if (this.zzagy > 0 && zzds.zza(this.zzaho)) {
                ...
                if (((Boolean) zzlc.zzio().zzd(zzoi.zzbrp)).booleanValue() && this.zzahn && this.zzagw != null) {
                    ...
                    long zza3 = zzds.zza((double) (((this.zzahj - this.zzahl) + this.zzagw.getRawY()) - this.zzagw.getY()), this.zzaho);
                    if (zza3 != 0) {
                        zzbb.zzfx = Long.valueOf(zza3);
                    }
                }
            }
            try {
                ...
                if (this.zzahn) {
                    ...
                    if (this.zzagz > 0) {
                        zzbb.zzfk = zzds.zza(this.zzaho) ? Long.valueOf(Math.round(((double) this.zzahe) / ((double) this.zzagz))) : null;
                        zzbb.zzfm = Long.valueOf(Math.round(((double) this.zzahd) / ((double) this.zzagz)));
                    }
                    zzbb.zzfq = zzb2.zzfq;
                    zzbb.zzfp = zzb2.zzfp;
            ...
            try {
                ...
                if (size > 0) {
                    ...
                    for (int i = 0; i < size; i++) {
                        zzdr zza4 = zza(zzagq, (MotionEvent) this.zzagx.get(i), this.zzaho);
                        zzbb zzbb2 = new zzbb();
                        zzbb2.zzdm = zza4.zzajl;
                        zzbb2.zzdn = zza4.zzajm;
                        zzba.zzes[i] = zzbb2;
                    }
                }
            } catch (zzdj unused3) {
    ...
    /* access modifiers changed from: protected */
    public final zzdr zzb(MotionEvent motionEvent) throws zzdj {
        ...
        try {
            return new zzdr((String) zza.invoke((Object) null, new Object[]{motionEvent, this.zzaho}));
        } catch (IllegalAccessException | InvocationTargetException e) {
            throw new zzdj(e);
        }
    }
