...
public final class zzcyz {
    ...
    private zzcyz(Context context, int i, String str, String str2, String str3, String str4) {
        ...
        this.zzkmb = newWakeLock;
        if (zzaa.zzda(applicationContext)) {
            WorkSource source = zzaa.zzw(context, zzw.zzhb(str3) ? context.getPackageName() : str3);
            this.zzkmc = source;
            if (source != null && zzaa.zzda(applicationContext)) {
                WorkSource existing = this.zzkmc;
                if (existing != null) {
                    existing.add(source);
                } else {
                    this.zzkmc = source;
                ...
                try {
                    newWakeLock.setWorkSource(this.zzkmc);
    ...
    public final void release() {
        ...
        L_0x000f:
            ...
            monitor-enter(r11)
            boolean r0 = r11.zzkmf     // Catch:{ all -> 0x0073 }
            r9 = 1
            r10 = 0
            if (r0 == 0) goto L_0x0046
            java.util.Map<java.lang.String, java.lang.Integer[]> r0 = r11.zzkmg     // Catch:{ all -> 0x0073 }
            java.lang.Object r0 = r0.get(r5)     // Catch:{ all -> 0x0073 }
        ...
        L_0x0027:
            ...
            int r1 = r1.intValue()     // Catch:{ all -> 0x0073 }
        ...
        L_0x0036:
            ...
            int r1 = r1.intValue()     // Catch:{ all -> 0x0073 }
            int r1 = r1 - r9
            java.lang.Integer r1 = java.lang.Integer.valueOf(r1)     // Catch:{ all -> 0x0073 }
        ...
        L_0x0046:
            ...
            int r0 = r11.zzkmh     // Catch:{ all -> 0x0073 }
            if (r0 != r9) goto L_0x006e
        L_0x004e:
            com.google.android.gms.common.stats.zze.zzanp()     // Catch:{ all -> 0x0073 }
            android.content.Context r1 = r11.mContext     // Catch:{ all -> 0x0073 }
            android.os.PowerManager$WakeLock r0 = r11.zzkmb     // Catch:{ all -> 0x0073 }
            java.lang.String r2 = com.google.android.gms.common.stats.zzc.zza(r0, r5)     // Catch:{ all -> 0x0073 }
            r3 = 8
            java.lang.String r4 = r11.zzgjx     // Catch:{ all -> 0x0073 }
            r6 = 0
            int r7 = r11.zzkmd     // Catch:{ all -> 0x0073 }
            android.os.WorkSource r0 = r11.zzkmc     // Catch:{ all -> 0x0073 }
            java.util.List r8 = com.google.android.gms.common.util.zzaa.zzb(r0)     // Catch:{ all -> 0x0073 }
