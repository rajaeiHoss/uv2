...
public final class zzaer extends zzd implements zzafs {
    ...
    public zzaer(Context context, zzv zzv, zzko zzko, zzwf zzwf, zzala zzala) {
        super(context, zzko, (String) null, zzwf, zzala, zzv);
        zzczu = this;
        this.zzaqg = new zzagt(context, (String) null);
    }
    ...
    private static zzahe zzc(zzahe zzahe) {
        ...
        try {
            JSONObject zzb = zzads.zzb(zzahe2.zzdcw);
            zzb.remove("impression_urls");
            JSONObject jSONObject = new JSONObject();
            jSONObject.put(AbstractAdViewAdapter.AD_UNIT_ID_PARAMETER, zzahe2.zzcvm.zzatx);
            zzvq zzvq = new zzvq(Arrays.asList(new zzvp[]{new zzvp(zzb.toString(), (String) null, Arrays.asList(new String[]{"com.google.ads.mediation.admob.AdMobAdapter"}), (String) null, (String) null, Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), jSONObject.toString(), (String) null, Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), (String) null, (String) null, (String) null, (List<String>) null, (String) null, Collections.emptyList(), (String) null, -1)}), ((Long) zzlc.zzio().zzd(zzoi.zzbrg)).longValue(), Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), false, "", -1, 0, 1, (String) null, 0, -1, -1, false);
            return new zzahe(zzahe2.zzcvm, zzahe2.zzdcw, zzvq, zzahe2.zzaud, zzahe2.errorCode, zzahe2.zzdcn, zzahe2.zzdco, zzahe2.zzdch, zzahe2.zzdcu, (Boolean) null);
        } catch (JSONException e) {
            zzahw.zzb("Unable to generate ad state for non-mediated rewarded video.", e);
            return new zzahe(zzahe2.zzcvm, zzahe2.zzdcw, (zzvq) null, zzahe2.zzaud, 0, zzahe2.zzdcn, zzahe2.zzdco, zzahe2.zzdch, zzahe2.zzdcu, (Boolean) null);
        }
    }
    ...
    public final void zzc(zzagd zzagd) {
        zzagd zzd = this.zzczw.zzd(zzagd);
        if (zzbt.zzfh().zzu(this.zzanm.zzaiq) && zzd != null) {
            zzbt.zzfh().zza(this.zzanm.zzaiq, zzbt.zzfh().zzz(this.zzanm.zzaiq), this.zzanm.zzatx, zzd.type, zzd.zzdax);
        }
        zza(zzd);
    }
