...
public abstract class zzfhu<MessageType extends zzfhu<MessageType, BuilderType>, BuilderType extends zza<MessageType, BuilderType>> extends zzfgj<MessageType, BuilderType> {
    ...
    public static abstract class zza<MessageType extends zzfhu<MessageType, BuilderType>, BuilderType extends zza<MessageType, BuilderType>> extends zzfgk<MessageType, BuilderType> {
        ...
        protected zza(MessageType messagetype) {
            ...
            this.zzppl = (MessageType) messagetype.zza(zzg.zzppx, (Object) null, (Object) null);
        }

        private void zza(MessageType messagetype, MessageType messagetype2) {
            zzf mergeVisitor = zzf.zzppq;
            messagetype.zza(zzg.zzpps, (Object) mergeVisitor, (Object) messagetype2);
            messagetype.zzpph = mergeVisitor.zza(messagetype.zzpph, messagetype2.zzpph);
        }
        ...
        public BuilderType clone() {
            BuilderType builder = (BuilderType) this.zzppk.zza(zzg.zzppy, (Object) null, (Object) null);
            if (!this.zzppm) {
        ...
        public final void zzczv() {
            if (this.zzppm) {
                MessageType messagetype = (MessageType) this.zzppl.zza(zzg.zzppx, (Object) null, (Object) null);
        ...
        public final MessageType zzczx() {
            ...
            if (byteValue != 1) {
                if (byteValue == 0) {
                    ...
                    messagetype2.zza(zzg.zzppu, z ? messagetype2 : null, (Object) null);
                }
            }
            if (z) {
                return messagetype2;
        ...
        public final /* synthetic */ zzfjc zzczz() {
            ...
            MessageType message = this.zzppl;
            Boolean bool = Boolean.TRUE;
            byte byteValue = ((Byte) message.zza(zzg.zzppt, (Object) null, (Object) null)).byteValue();
            if (byteValue != 1) {
                if (byteValue == 0) {
                    z = false;
                } else {
                    if (message.zza(zzg.zzppr, (Object) Boolean.FALSE, (Object) null) == null) {
                        z = false;
                    }
                    message.zza(zzg.zzppu, z ? message : null, (Object) null);
                }
            }
            if (z) {
                return message;
            }
            throw new zzfkm(message);
        }
    }
    ...
    public static class zzb<T extends zzfhu<T, ?>> extends zzfgm<T> {
        ...
        public final T zze(zzfhb zzfhb, zzfhm zzfhm) throws zzfie {
    ...
    static class zzc implements zzh {
        ...
        public final <T extends zzfjc> T zza(T t, T t2) {
            ...
            zzfhu message = (zzfhu) t;
            if (message != t2 && ((zzfhu) message.zza(zzg.zzppz, (Object) null, (Object) null)).getClass().isInstance(t2)) {
                zzfhu other = (zzfhu) t2;
                message.zza(zzg.zzpps, (Object) this, (Object) other);
                message.zzpph = zza(message.zzpph, other.zzpph);
            }
            return t;
        }
    ...
    public static abstract class zzd<MessageType extends zzd<MessageType, BuilderType>, BuilderType extends zza<MessageType, BuilderType>> extends zzfhu<MessageType, BuilderType> implements zzfje {
        protected zzfhq zzppp = zzfhq.zzczj();
    }
    ...
    protected static <T extends zzfhu<T, ?>> T zza(T t, zzfgs zzfgs) throws zzfie {
        ...
        if (zza2 != null) {
            ...
            if (byteValue == 1) {
                ...
                zza2.zza(zzg.zzppu, z ? zza2 : null, (Object) null);
            }
            if (!z) {
        ...
        if (zza2 != null) {
            ...
            if (byteValue2 == 1) {
                ...
                zza2.zza(zzg.zzppu, z2 ? zza2 : null, (Object) null);
            }
            if (!z2) {
                throw new zzfkm(zza2).zzdbz().zzi(zza2);
            }
    ...
    static <T extends zzfhu<T, ?>> T zza(T t, zzfhb zzfhb, zzfhm zzfhm) throws zzfie {
        T t2 = (T) t.zza(zzg.zzppx, (Object) null, (Object) null);
        try {
    ...
    protected static final <T extends zzfhu<T, ?>> boolean zza(T t, boolean z) {
        ...
        return (byteValue == 0 || t.zza(zzg.zzppr, (Object) Boolean.FALSE, (Object) null) == null) ? false : true;
    }
    ...
    public void zza(zzfhg zzfhg) throws IOException {
        zzfjn.zzdbf().zzl((Class) getClass()).zza(this, zzfhi.zzb(zzfhg));
    }
    ...
    public int zzhs() {
        if (this.zzppi == -1) {
            this.zzppi = zzfjn.zzdbf().zzl((Class) getClass()).zzct(this);
        }
        return this.zzppi;
    }
}
