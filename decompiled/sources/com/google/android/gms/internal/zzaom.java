...
final /* synthetic */ class zzaom implements zzald {
    ...
    public final zzalt zzc(Object obj) throws Exception {
        Context context = this.zzdpw;
        zzcv zzcv = this.zzcfn;
        zzala zzala = this.zzdpx;
        zzv zzv = this.zzdpy;
        String str = this.zzdpz;
        zzaof zza = zzbt.zzem().zza(context, zzaqa.zzvj(), "", false, false, zzcv, zzala, (zzov) null, (zzbm) null, zzv, zziu.zzhp());
        zzamc zzi = zzamc.zzi(zza);
        zza.zzua().zza((zzapv) new zzaon(zzi));
        zza.loadUrl(str);
        return zzi;
    }
}
