...
public final class zzbhq<I, O> extends zzbgl {
    ...
    zzbhq(int i, int i2, boolean z, int i3, boolean z2, String str, int i4, String str2, zzbhj zzbhj) {
        ...
        if (zzbhj == null) {
            ...
            this.zzgix = (zzbhr<I, O>) zzbhj.zzand();
        }
    }
    ...
    public static zzbhq zza(String str, int i, zzbhr<?, ?> zzbhr, boolean z) {
        return new zzbhq(7, false, 0, false, str, i, (Class<? extends zzbhp>) null, zzbhr);
    }

    public static <T extends zzbhp> zzbhq<T, T> zza(String str, int i, Class<T> cls) {
        return new zzbhq(11, false, 11, false, str, i, cls, (zzbhr) null);
    }
    ...
    public static <T extends zzbhp> zzbhq<ArrayList<T>, ArrayList<T>> zzb(String str, int i, Class<T> cls) {
        return new zzbhq(11, true, 11, true, str, i, cls, (zzbhr) null);
    }

    public static zzbhq<Integer, Integer> zzj(String str, int i) {
        return new zzbhq(0, false, 0, false, str, i, (Class<? extends zzbhp>) null, (zzbhr) null);
    }

    public static zzbhq<Boolean, Boolean> zzk(String str, int i) {
        return new zzbhq(6, false, 6, false, str, i, (Class<? extends zzbhp>) null, (zzbhr) null);
    }

    public static zzbhq<String, String> zzl(String str, int i) {
        return new zzbhq(7, false, 7, false, str, i, (Class<? extends zzbhp>) null, (zzbhr) null);
    }

    public static zzbhq<ArrayList<String>, ArrayList<String>> zzm(String str, int i) {
        return new zzbhq(7, true, 7, true, str, i, (Class<? extends zzbhp>) null, (zzbhr) null);
    }

    public static zzbhq<byte[], byte[]> zzn(String str, int i) {
        return new zzbhq(8, false, 8, false, str, 4, (Class<? extends zzbhp>) null, (zzbhr) null);
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        zzbhr<I, O> zzbhr = this.zzgix;
        zzbgo.zza(parcel, 9, (Parcelable) zzbhr == null ? null : zzbhj.zza(zzbhr), i, false);
