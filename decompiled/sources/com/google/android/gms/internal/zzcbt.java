...
public final class zzcbt implements BleApi {
    public static final Status zzhnn = new Status(FitnessStatusCodes.UNSUPPORTED_PLATFORM);

    public final PendingResult<Status> claimBleDevice(GoogleApiClient googleApiClient, BleDevice bleDevice) {
        return PendingResults.zza(zzhnn, googleApiClient);
    }
    ...
    public final PendingResult<BleDevicesResult> listClaimedBleDevices(GoogleApiClient googleApiClient) {
        return PendingResults.zza(BleDevicesResult.zzae(zzhnn), googleApiClient);
    }
