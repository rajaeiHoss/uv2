...
public final class zznu {
    ...
    public final boolean zzjc() {
        return ((Boolean) zzakg.zza(this.mContext, new zznv())).booleanValue() && zzbih.zzdd(this.mContext).checkCallingOrSelfPermission(Permission.WRITE_EXTERNAL_STORAGE) == 0;
    }
