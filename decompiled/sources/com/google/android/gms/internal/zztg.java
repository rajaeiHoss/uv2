...
final class zztg implements zzf {
    ...
    public final void onConnected(Bundle bundle) {
        synchronized (this.zzcdd.mLock) {
            if (!this.zzcdd.zzcdc) {
                boolean unused = this.zzcdd.zzcdc = true;
                zzsx zzd = this.zzcdd.zzcdb;
                if (zzd != null) {
                    zzalt<Void> zzb = zzaid.zzb(new zzth(this, zzd, this.zzcde, this.zzcdf));
                    zzamd zzamd = this.zzcde;
                    zzamd.zza(new zzti(zzamd, zzb), zzaly.zzdju);
                }
            }
        }
    }
