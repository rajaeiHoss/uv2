...
public final class zzaol {
    ...
    public final zzaof zza(Context context, zzaqa zzaqa, String str, boolean z, boolean z2, zzcv zzcv, zzala zzala, zzov zzov, zzbm zzbm, zzv zzv, zziu zziu) throws zzaop {
        ...
        try {
            ...
            return (zzaof) zzakg.zzb(context, new zzaoo(this, context, zzaqa, str, z, z2, zzcv, zzala, zzov, zzbm, zzv, zziu));
        } catch (Throwable th) {
