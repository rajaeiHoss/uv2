...
public class AppInviteReferral {
    ...
    public static Intent addPlayStoreReferrerToIntent(Intent intent, Intent intent2) {
        Bundle zze = zze(intent);
        if (!(zze == null || intent2 == null)) {
            intent2.putExtra("com.google.android.gms.appinvite.REFERRAL_BUNDLE", zze);
        }
        return intent2;
    }
    ...
    private static Bundle zze(Intent intent) {
