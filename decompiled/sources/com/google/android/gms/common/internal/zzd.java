...
public abstract class zzd<T extends IInterface> {
    ...
    private int zzgfa;
    /* access modifiers changed from: private */
    public final com.google.android.gms.common.internal.zzf zzgfb;
    /* access modifiers changed from: private */
    ...
    protected zzd(Context context, Looper looper, int i, com.google.android.gms.common.internal.zzf connectionCallbacks, zzg connectionFailedListener, String str) {
        this(context, looper, zzag.zzcp(context), zzf.zzahf(), i, (com.google.android.gms.common.internal.zzf) zzbq.checkNotNull(connectionCallbacks), (zzg) zzbq.checkNotNull(connectionFailedListener), (String) null);
    }

    protected zzd(Context context, Looper looper, zzag zzag, zzf apiAvailability, int i, com.google.android.gms.common.internal.zzf connectionCallbacks, zzg connectionFailedListener, String str) {
        ...
        this.zzfwk = (zzf) zzbq.checkNotNull(apiAvailability, "API availability must not be null");
        this.mHandler = new zzh(this, looper);
        this.zzgfd = i;
        this.zzgfb = connectionCallbacks;
        this.zzgfc = connectionFailedListener;
        this.zzgfe = str;
    }
    ...
    public final void zza(int i, T t) {
        ...
        synchronized (this.mLock) {
            ...
            if (i != 1) {
                if (i == 2 || i == 3) {
                    if (!(this.zzgez == null || (zzam = this.zzges) == null)) {
                        String zzamx = zzam.zzamx();
                    ...
                    zzam zzam2 = new zzam(zzalq(), zzhm(), false, 129);
                    this.zzges = zzam2;
                    if (!this.zzget.zza(new zzah(zzam2.zzamx(), this.zzges.getPackageName(), this.zzges.zzamu()), (ServiceConnection) this.zzgez, zzalr())) {
    ...
    public final void zza(zzan zzan, Set<Scope> set) {
        ...
        try {
            synchronized (this.zzgeu) {
                ...
                if (zzay != null) {
                    zzay.zza(new zzk(this, this.zzgfh.get()), zzz);
                } else {
    ...
    public final IBinder zzaho() {
        synchronized (this.zzgeu) {
            ...
            IBinder asBinder = zzay.asBinder();
            return asBinder;
        }
    }
