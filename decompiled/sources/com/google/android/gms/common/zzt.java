...
public class zzt {
    ...
    public final boolean zzbp(int i) {
        ...
        if (packagesForUid != null && packagesForUid.length != 0) {
            ...
            zzpVar = zzp.zzgg("no pkgs");
        }
        if (!zzpVar.zzfrm) {
            if (zzpVar.cause != null) {
                Log.d("GoogleCertificatesRslt", zzpVar.getErrorMessage(), zzpVar.cause);
            } else {
                Log.d("GoogleCertificatesRslt", zzpVar.getErrorMessage());
            }
        }
        return zzpVar.zzfrm;
    }
