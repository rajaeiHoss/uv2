...
public final class zzdc extends Fragment implements zzcf {
    ...
    public static zzdc zza(FragmentActivity fragmentActivity) {
        ...
        try {
            zzdc zzdc2 = (zzdc) fragmentActivity.getSupportFragmentManager().findFragmentByTag("SupportLifecycleFragmentImpl");
            if (zzdc2 == null || zzdc2.isRemoving()) {
                zzdc2 = new zzdc();
                fragmentActivity.getSupportFragmentManager().beginTransaction().add((Fragment) zzdc2, "SupportLifecycleFragmentImpl").commitAllowingStateLoss();
            }
            zzgan.put(fragmentActivity, new WeakReference(zzdc2));
            return zzdc2;
