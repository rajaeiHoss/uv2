    ...
    public final void run() {
        if (this.zzfuy.mStarted) {
            ...
            if (zzain.hasResolution()) {
                ...
                GoogleApiAvailability.zza(this.zzfuy.getActivity().getApplicationContext(), (zzby) new zzr(this, GoogleApiAvailability.zza(this.zzfuy.getActivity(), (DialogInterface.OnCancelListener) this.zzfuy)));
            } else {
