...
public final class SignInConfiguration extends zzbgl implements ReflectedParcelable {
    ...
    public final boolean equals(Object obj) {
        ...
        try {
            ...
            if (this.zzeob.equals(signInConfiguration.zzeob)) {
                GoogleSignInOptions googleSignInOptions = this.zzeoc;
                if (googleSignInOptions == null) {
                    if (signInConfiguration.zzeoc == null) {
                        return true;
                    }
                } else if (googleSignInOptions.equals(signInConfiguration.zzeoc)) {
                    return true;
                }
            }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        zzbgo.zza(parcel, 5, (Parcelable) this.zzeoc, i, false);
