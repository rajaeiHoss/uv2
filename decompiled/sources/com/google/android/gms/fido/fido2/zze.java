...
final class zze extends zzde<zzbvj, Fido2PendingIntent> {
    private /* synthetic */ BrowserMakeCredentialOptions zzheg;

    zze(Fido2PrivilegedApiClient fido2PrivilegedApiClient, BrowserMakeCredentialOptions browserMakeCredentialOptions) {
        this.zzheg = browserMakeCredentialOptions;
    }
    ...
    public final void zza(zzbvj zzbvj, TaskCompletionSource<Fido2PendingIntent> taskCompletionSource) throws RemoteException {
        ((zzbvn) zzbvj.zzalw()).zza((zzbvl) new zzf(this, taskCompletionSource), this.zzheg);
    }
}
