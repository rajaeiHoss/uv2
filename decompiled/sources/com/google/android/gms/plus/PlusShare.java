...
public final class PlusShare {
    ...
    public static class Builder {
        ...
        public Builder addCallToAction(String str, Uri uri, String str2) {
            ...
            zzbq.checkArgument(uri != null && !TextUtils.isEmpty(uri.toString()), "Must provide a call to action URL");
        ...
        public Intent getIntent() {
            ArrayList<Uri> arrayList = this.zzkhs;
            boolean z = true;
            ...
            zzbq.zza(!z2 || !booleanExtra, (Object) "Call-to-action buttons are only available for URLs.");
            zzbq.zza(!booleanExtra || this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_URL), (Object) "The content URL is required for interactive posts.");
            ...
            if (!z2 && equals) {
                ...
                ArrayList<Uri> arrayList2 = this.zzkhs;
                if (arrayList2 == null || arrayList2.isEmpty()) {
                    this.mIntent.removeExtra("android.intent.extra.STREAM");
                } else {
                    this.mIntent.putExtra("android.intent.extra.STREAM", this.zzkhs.get(0));
                }
                this.zzkhs = null;
            }
            if (z2 && !equals) {
                this.mIntent.setAction("android.intent.action.SEND_MULTIPLE");
                ArrayList<Uri> arrayList3 = this.zzkhs;
        ...
        public Builder setContentDeepLinkId(String str, String str2, String str3, Uri uri) {
            ...
            zzbq.checkArgument(!TextUtils.isEmpty(str), "The deepLinkId parameter is required.");
            Bundle bundle = new Bundle();
    ...
    public static Person createPerson(String str, String str2) {
        if (TextUtils.isEmpty(str)) {
            ...
            return new zzcwn(str2, str, (zzcwn.zzc) null, 0, (String) null);
        } else {
