...
public final class Action extends Thing {
    ...
    public static final class Builder extends Thing.Builder {
        public Builder(String str) {
            ...
            super.put(AppMeasurement.Param.TYPE, str);
        }

        public final Action build() {
            zzbq.checkNotNull(this.zzegt.get("object"), "setObject is required before calling build().");
            zzbq.checkNotNull(this.zzegt.get(AppMeasurement.Param.TYPE), "setType is required before calling build().");
            Bundle bundle = (Bundle) this.zzegt.getParcelable("object");
            ...
            zzbq.checkNotNull(bundle.get(PlusShare.KEY_CALL_TO_ACTION_URL), "Must call setObject() with a valid app URI. Example: setObject(new Thing.Builder().setName(name).setUrl(url))");
            return new Action(this.zzegt);
        }
