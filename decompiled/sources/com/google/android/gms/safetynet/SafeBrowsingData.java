...
public class SafeBrowsingData extends zzbgl {
    ...
    private final java.io.FileOutputStream zzalg() {
        ...
        L_0x0006:
            ...
            r5.zzcup = r3     // Catch:{ IOException -> 0x0023, all -> 0x0021 }
    ...
    public void writeToParcel(android.os.Parcel r4, int r5) {
        /*
            r3 = this;
            android.os.ParcelFileDescriptor r0 = r3.zzcup
            r1 = 1
            if (r0 != 0) goto L_0x0031
            byte[] r0 = r3.zzkkg
            if (r0 == 0) goto L_0x0031
            java.io.FileOutputStream r0 = r3.zzalg()
            if (r0 == 0) goto L_0x0031
            java.io.BufferedOutputStream r2 = new java.io.BufferedOutputStream
            r2.<init>(r0)
            java.io.DataOutputStream r0 = new java.io.DataOutputStream
            r0.<init>(r2)
            byte[] r2 = r3.zzkkg     // Catch:{ IOException -> 0x002e, all -> 0x0029 }
