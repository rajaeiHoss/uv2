...
public class DataBufferAdapter<T> extends BaseAdapter {
    private static final zzal zzgpv = new zzal("DataBufferAdapter", "");
    private final Context mContext;
    private final LayoutInflater mInflater;
    private final int zzhck;
    private int zzhcl;
    private final int zzhcm;
    private final List<DataBuffer<T>> zzhcn;
    ...
    private final View zza(int i, View view, ViewGroup viewGroup, int i2) {
        ...
        try {
            ...
            zzgpv.zzd("DataBufferAdapter", "You must supply a resource ID for a TextView", (Throwable) e);
    ...
    public void clear() {
        for (DataBuffer<T> release : this.zzhcn) {
            release.release();
        }
        this.zzhcn.clear();
        if (this.zzhco) {
    ...
    public int getCount() {
        int i = 0;
        for (DataBuffer<T> count : this.zzhcn) {
            i += count.getCount();
        }
        return i;
    }
    ...
    public View getDropDownView(int i, View view, ViewGroup viewGroup) {
        return zza(i, view, viewGroup, this.zzhcl);
    }

    public T getItem(int i) throws CursorIndexOutOfBoundsException {
        int i2 = i;
        for (DataBuffer<T> next : this.zzhcn) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        return zza(i, view, viewGroup, this.zzhck);
    }
