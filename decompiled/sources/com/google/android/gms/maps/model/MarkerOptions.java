...
public final class MarkerOptions extends zzbgl {
    ...
    MarkerOptions(LatLng latLng, String str, String str2, IBinder iBinder, float f, float f2, boolean z, boolean z2, boolean z3, float f3, float f4, float f5, float f6, float f7) {
        ...
        this.title = str;
        this.zzjdv = str2;
        this.zzjdw = iBinder == null ? null : new BitmapDescriptor(IObjectWrapper.zza.zzaq(iBinder));
        this.zzjdj = f;
        this.zzjdk = f2;
        this.zzjdx = z;
        this.zzjdb = z2;
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        zzbgo.zza(parcel, 5, bitmapDescriptor == null ? null : bitmapDescriptor.zzaxq().asBinder(), false);
