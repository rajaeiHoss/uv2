...
public abstract class zzbq extends zzew implements zzbp {
    ...
    public boolean onTransact(int r2, android.os.Parcel r3, android.os.Parcel r4, int r5) throws android.os.RemoteException {
        ...
        L_0x0012:
            ...
            boolean r5 = r3 instanceof com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate
        ...
        L_0x002d:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.maps.internal.zzbq.onTransact(int, android.os.Parcel, android.os.Parcel, int):boolean");
    }
}
