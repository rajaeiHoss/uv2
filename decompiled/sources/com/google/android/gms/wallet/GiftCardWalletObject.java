...
public final class GiftCardWalletObject extends zzbgl {
    ...
    public final class Builder {
        ...
        public final GiftCardWalletObject build() {
            zzbq.checkArgument(!TextUtils.isEmpty(GiftCardWalletObject.this.zzlkq), "Card number is required.");
            GiftCardWalletObject.this.zzlkp = this.zzlkw.zzblv();
            zzbq.checkArgument(!TextUtils.isEmpty(GiftCardWalletObject.this.zzlkp.getName()), "Card name is required.");
            zzbq.checkArgument(!TextUtils.isEmpty(GiftCardWalletObject.this.zzlkp.getIssuerName()), "Card issuer name is required.");
            return GiftCardWalletObject.this;
        }

        public final Builder setBalanceCurrencyCode(String str) {
            GiftCardWalletObject.this.zzlkt = str;
            return this;
        }

        public final Builder setBalanceMicros(long j) {
            GiftCardWalletObject.this.zzlks = j;
            return this;
        }

        public final Builder setBalanceUpdateTime(long j) {
            GiftCardWalletObject.this.zzlku = j;
            return this;
        }
        ...
        public final Builder setCardIdentifier(String str) {
            GiftCardWalletObject.this.zzlkr = str;
            return this;
        }

        public final Builder setCardNumber(String str) {
            GiftCardWalletObject.this.zzlkq = str;
            return this;
        }
        ...
        public final Builder setEventNumber(String str) {
            GiftCardWalletObject.this.zzlkv = str;
            return this;
        }
    ...
    public static Builder newBuilder() {
        ...
        return giftCardWalletObject.new Builder();
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        zzbgo.zza(parcel, 2, (Parcelable) this.zzlkp, i, false);
