...
public final class OfferWalletObject extends zzbgl {
    ...
    public final class Builder {
        ...
        public final OfferWalletObject build() {
            OfferWalletObject.this.zzlkp = this.zzlkw.zzblv();
        ...
        public final Builder setId(String str) {
            this.zzlkw.zzns(str);
            OfferWalletObject.this.zzwc = str;
            return this;
        }
        ...
        public final Builder setRedemptionCode(String str) {
            OfferWalletObject.this.zzlmv = str;
            return this;
        }
    ...
    public static Builder newBuilder() {
        return new OfferWalletObject().new Builder();
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        zzbgo.zza(parcel, 4, (Parcelable) this.zzlkp, i, false);
