...
public final class zzbu implements ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener {
    ...
    public zzbu(Context context, zzko zzko, String str, zzala zzala) {
        this(context, zzko, str, zzala, (zzcv) null);
    }
    ...
    private zzbu(Context context, zzko zzko, String str, zzala zzala, zzcv zzcv) {
        ...
        if (zzko.zzbib || zzko.zzbid) {
            ...
            zzbv zzbv = new zzbv(context, str, zzala.zzcu, this, this);
            this.zzaua = zzbv;
            zzbv.setMinimumWidth(zzko.widthPixels);
    ...
    private final void zzf(boolean z) {
        zzahd zzahd;
        View findViewById;
        if (this.zzaua != null && (zzahd = this.zzaue) != null && zzahd.zzcnm != null && this.zzaue.zzcnm.zzua() != null) {
            if (!z || this.zzavf.tryAcquire()) {
                ...
                if (zzbv != null && (findViewById = zzbv.getRootView().findViewById(16908290)) != null) {
                    Rect rect = new Rect();
                    Rect rect2 = new Rect();
    ...
    public final String zzfq() {
        boolean z = this.zzavg;
        return (!z || !this.zzavh) ? z ? this.zzavi ? "top-scrollable" : "top-locked" : this.zzavh ? this.zzavi ? "bottom-scrollable" : "bottom-locked" : "" : "";
    }

    public final void zzg(boolean z) {
        zzahd zzahd;
        if (!(this.zzavb != 0 || (zzahd = this.zzaue) == null || zzahd.zzcnm == null)) {
