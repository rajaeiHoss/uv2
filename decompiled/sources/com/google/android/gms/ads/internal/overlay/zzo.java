...
public final class zzo extends FrameLayout implements View.OnClickListener {
    ...
    public zzo(Context context, zzp zzp, zzw zzw) {
        ...
        zzlc.zzij();
        int zza4 = zzako.zza(context, zzp.size + zzp.paddingLeft + zzp.paddingRight);
        zzlc.zzij();
        addView(imageButton, new FrameLayout.LayoutParams(zza4, zzako.zza(context, zzp.size + zzp.paddingBottom), 17));
    }
