...
public class AdvertisingIdClient {
    ...
    private static zzfp zza(Context context, com.google.android.gms.common.zza zza2) throws IOException {
        try {
            return zzfq.zzc(zza2.zza(NotificationOptions.SKIP_STEP_TEN_SECONDS_IN_MS, TimeUnit.MILLISECONDS));
        } catch (InterruptedException unused) {
    ...
    private final void zzbm() {
        /*
            r6 = this;
            java.lang.Object r0 = r6.zzamv
            monitor-enter(r0)
            com.google.android.gms.ads.identifier.AdvertisingIdClient$zza r1 = r6.zzamw     // Catch:{ all -> 0x0024 }
            if (r1 == 0) goto L_0x0011
            java.util.concurrent.CountDownLatch r1 = r1.zzanc     // Catch:{ all -> 0x0024 }
            r1.countDown()     // Catch:{ all -> 0x0024 }
            com.google.android.gms.ads.identifier.AdvertisingIdClient$zza r1 = r6.zzamw     // Catch:{ InterruptedException -> 0x0011 }
            r1.join()     // Catch:{ InterruptedException -> 0x0011 }
        L_0x0011:
            long r1 = r6.zzamy     // Catch:{ all -> 0x0024 }
            r3 = 0
            ...
            long r2 = r6.zzamy     // Catch:{ all -> 0x0024 }
            r1.<init>(r6, r2)     // Catch:{ all -> 0x0024 }
            r6.zzamw = r1     // Catch:{ all -> 0x0024 }
        L_0x0022:
