...
final class zzar extends RemoteMediaPlayer.zzb {
    ...
    public final void zza(com.google.android.gms.internal.zzbdp r12) {
        /*
            ...
            monitor-enter(r12)
            com.google.android.gms.cast.RemoteMediaPlayer r0 = r11.zzexz     // Catch:{ all -> 0x0056 }
            com.google.android.gms.cast.RemoteMediaPlayer$zza r0 = r0.zzexu     // Catch:{ all -> 0x0056 }
            com.google.android.gms.common.api.GoogleApiClient r1 = r11.zzeya     // Catch:{ all -> 0x0056 }
            r0.zzb(r1)     // Catch:{ all -> 0x0056 }
            r0 = 0
            com.google.android.gms.cast.RemoteMediaPlayer r1 = r11.zzexz     // Catch:{ zzbel | IllegalStateException -> 0x0033 }
            com.google.android.gms.internal.zzbej r2 = r1.zzext     // Catch:{ zzbel | IllegalStateException -> 0x0033 }
            com.google.android.gms.internal.zzben r3 = r11.zzezb     // Catch:{ zzbel | IllegalStateException -> 0x0033 }
            r4 = 0
            r5 = -1
            com.google.android.gms.cast.MediaQueueItem[] r7 = r11.zzeyl     // Catch:{ zzbel | IllegalStateException -> 0x0033 }
            r8 = 0
            r9 = 0
            org.json.JSONObject r10 = r11.zzeyh     // Catch:{ zzbel | IllegalStateException -> 0x0033 }
            r2.zza((com.google.android.gms.internal.zzben) r3, (int) r4, (long) r5, (com.google.android.gms.cast.MediaQueueItem[]) r7, (int) r8, (java.lang.Integer) r9, (org.json.JSONObject) r10)     // Catch:{ zzbel | IllegalStateException -> 0x0033 }
            com.google.android.gms.cast.RemoteMediaPlayer r1 = r11.zzexz     // Catch:{ all -> 0x0056 }
            com.google.android.gms.cast.RemoteMediaPlayer$zza r1 = r1.zzexu     // Catch:{ all -> 0x0056 }
        L_0x002d:
        ...
        L_0x0033:
            ...
            com.google.android.gms.common.api.Result r1 = r11.zzb(r1)     // Catch:{ all -> 0x0031 }
        ...
        L_0x004a:
            ...
            return
        L_0x004c:
            com.google.android.gms.cast.RemoteMediaPlayer r2 = r11.zzexz     // Catch:{ all -> 0x0056 }
            com.google.android.gms.cast.RemoteMediaPlayer$zza r2 = r2.zzexu     // Catch:{ all -> 0x0056 }
        ...
        L_0x0056:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.cast.zzar.zza(com.google.android.gms.internal.zzbdp):void");
    }
}
