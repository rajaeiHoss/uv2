...
final class zzp implements Runnable {
    ...
    public final void run() {
        ...
        zzaqy zzb = this.zzdwi.zzyh();
        if (this.zzdwc) {
            zzatt.zzb((Map<String, String>) this.zzdwb, "ate", zzb.zzxg());
            zzatt.zzb((Map<String, String>) this.zzdwb, "adid", zzb.zzxn());
        } else {
            this.zzdwb.remove("ate");
            this.zzdwb.remove("adid");
        }
        zzaql zzzd = this.zzdwi.zzyi().zzzd();
        ...
        zzatt.zzb((Map<String, String>) this.zzdwb, "ul", this.zzdwi.zzyj().zzaah().getLanguage());
        zzatt.zzb((Map<String, String>) this.zzdwb, "sr", this.zzdwi.zzyj().zzaai());
        if ((this.zzdwd.equals("transaction") || this.zzdwd.equals("item")) || this.zzdwi.zzdvx.zzaas()) {
            ...
            long j = zzeo;
            if (this.zzdwf) {
                this.zzdwi.zzxy().zzc("Dry run enabled. Would have sent hit", new zzasy(this.zzdwi, this.zzdwb, j, this.zzdwg));
                return;
            }
            ...
            this.zzdwb.put("_s", String.valueOf(this.zzdwi.zzyc().zza(new zzarn(0, (String) this.zzdwb.get("cid"), this.zzdwh, !TextUtils.isEmpty((CharSequence) this.zzdwb.get("adid")), 0, hashMap))));
            this.zzdwi.zzyc().zza(new zzasy(this.zzdwi, this.zzdwb, j, this.zzdwg));
            return;
        }
        this.zzdwi.zzxy().zzf(this.zzdwb, "Too many hits sent too quickly, rate limiting invoked");
    }
}
