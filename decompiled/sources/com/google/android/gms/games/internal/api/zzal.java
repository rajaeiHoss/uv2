...
final class zzal extends zzat {
    ...
    zzal(zzah zzah, GoogleApiClient googleApiClient, String str, int i, int i2, int i3, boolean z) {
    ...
    public final /* synthetic */ void zza(GamesClientImpl gamesClientImpl) throws RemoteException {
        gamesClientImpl.zza(this, this.zzhsx, this.zziam, this.zzian, this.zziao, this.zziah);
    }
}
