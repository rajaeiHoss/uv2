...
final class BitMatrixParser {
    ...
    BitMatrixParser(BitMatrix bitMatrix) throws FormatException {
        ...
        this.readMappingMatrix = new BitMatrix(extractDataRegion.getHeight());
    }
    ...
    public byte[] readCodewords() throws FormatException {
        ...
        while (true) {
            if (i3 == height && i == 0 && !z) {
                bArr[i2] = (byte) readCorner1(height, height);
                i3 -= 2;
                i += 2;
                i2++;
                z = true;
                ...
                int i4 = height - 2;
                if (i3 == i4 && i == 0 && (height & 3) != 0 && !z2) {
                    bArr[i2] = (byte) readCorner2(height, height);
                    i3 -= 2;
                    i += 2;
                    i2++;
                    z2 = true;
                } else if (i3 == height + 4 && i == 2 && (height & 7) == 0 && !z3) {
                    bArr[i2] = (byte) readCorner3(height, height);
                    i3 -= 2;
                    i += 2;
                    i2++;
                    z3 = true;
                } else if (i3 == i4 && i == 0 && (height & 7) == 4 && !z4) {
                    bArr[i2] = (byte) readCorner4(height, height);
                    i3 -= 2;
                    i += 2;
                    i2++;
                    z4 = true;
                    ...
                    do {
                        if (i3 < height && i >= 0 && !this.readMappingMatrix.get(i, i3)) {
                            bArr[i2] = (byte) readUtah(i3, i, height, height);
                            i2++;
                        }
                        i3 -= 2;
                        i += 2;
                    ...
                    int i6 = i + 3;
                    do {
                        if (i5 >= 0 && i6 < height && !this.readMappingMatrix.get(i6, i5)) {
                            bArr[i2] = (byte) readUtah(i5, i6, height, height);
                            i2++;
                        }
                        i5 += 2;
                        i6 -= 2;
    ...
    /* access modifiers changed from: package-private */
    public Version readVersion(BitMatrix bitMatrix) throws FormatException {
