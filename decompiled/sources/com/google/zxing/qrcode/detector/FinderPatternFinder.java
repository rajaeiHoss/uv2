...
public class FinderPatternFinder {
    ...
    protected static boolean foundPatternCross(int[] r6) {
        /*
            r0 = 0
            r1 = 0
            r2 = 0
        ...
        L_0x005b:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.zxing.qrcode.detector.FinderPatternFinder.foundPatternCross(int[]):boolean");
    }
    ...
    private FinderPattern[] selectBestPatterns() throws NotFoundException {
        ...
        if (size >= 3) {
            ...
            if (size > 3) {
                ...
                Collections.insertionSort(this.possibleCenters, new FurthestFromAverageComparator(f5));
                float max = Math.max(0.2f * f5, sqrt);
                int i2 = 0;
                while (i2 < this.possibleCenters.size() && this.possibleCenters.size() > 3) {
                    if (Math.abs(((FinderPattern) this.possibleCenters.elementAt(i2)).getEstimatedModuleSize() - f5) > max) {
