...
class JsonUtils {
    private static final JsonReader.Options POINT_NAMES = JsonReader.Options.of(GroupChatInvitation.ELEMENT_NAME, "y");
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            $SwitchMap$com$airbnb$lottie$parser$moshi$JsonReader$Token = new int[JsonReader.Token.values().length];
            try {
