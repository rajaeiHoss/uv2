...
public class PolystarContent implements PathContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    public <T> void addValueCallback(T t, LottieValueCallback<T> lottieValueCallback) {
        ...
        if (t == LottieProperty.POLYSTAR_POINTS) {
            this.pointsAnimation.setValueCallback((LottieValueCallback<Float>) lottieValueCallback);
        } else if (t == LottieProperty.POLYSTAR_ROTATION) {
            this.rotationAnimation.setValueCallback((LottieValueCallback<Float>) lottieValueCallback);
            ...
            this.outerRadiusAnimation.setValueCallback((LottieValueCallback<Float>) lottieValueCallback);
            ...
            this.outerRoundednessAnimation.setValueCallback((LottieValueCallback<Float>) lottieValueCallback);
        }
    }
}
