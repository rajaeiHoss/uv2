...
public class GradientFillContent implements DrawingContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    public <T> void addValueCallback(T t, LottieValueCallback<T> lottieValueCallback) {
        ...
        if (t == LottieProperty.OPACITY) {
            ...
            ValueCallbackKeyframeAnimation valueCallbackKeyframeAnimation = new ValueCallbackKeyframeAnimation((LottieValueCallback<ColorFilter>) lottieValueCallback);
            ...
            ValueCallbackKeyframeAnimation valueCallbackKeyframeAnimation3 = new ValueCallbackKeyframeAnimation((LottieValueCallback<int[]>) lottieValueCallback);
            ...
            ValueCallbackKeyframeAnimation valueCallbackKeyframeAnimation4 = new ValueCallbackKeyframeAnimation((LottieValueCallback<Float>) lottieValueCallback);
            ...
            dropShadowKeyframeAnimation5.setColorCallback((LottieValueCallback<Integer>) lottieValueCallback);
        } else if (t == LottieProperty.DROP_SHADOW_OPACITY && (dropShadowKeyframeAnimation4 = this.dropShadowAnimation) != null) {
            dropShadowKeyframeAnimation4.setOpacityCallback((LottieValueCallback<Float>) lottieValueCallback);
        } else if (t == LottieProperty.DROP_SHADOW_DIRECTION && (dropShadowKeyframeAnimation3 = this.dropShadowAnimation) != null) {
            dropShadowKeyframeAnimation3.setDirectionCallback((LottieValueCallback<Float>) lottieValueCallback);
        } else if (t == LottieProperty.DROP_SHADOW_DISTANCE && (dropShadowKeyframeAnimation2 = this.dropShadowAnimation) != null) {
            dropShadowKeyframeAnimation2.setDistanceCallback((LottieValueCallback<Float>) lottieValueCallback);
        } else if (t == LottieProperty.DROP_SHADOW_RADIUS && (dropShadowKeyframeAnimation = this.dropShadowAnimation) != null) {
            dropShadowKeyframeAnimation.setRadiusCallback((LottieValueCallback<Float>) lottieValueCallback);
        }
    }
}
