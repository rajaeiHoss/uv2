...
public class TransformKeyframeAnimation {
    ...
    public <T> boolean applyValueCallback(T t, LottieValueCallback<T> lottieValueCallback) {
        ...
        if (t == LottieProperty.TRANSFORM_ANCHOR_POINT) {
            ...
            if (baseKeyframeAnimation3 == null) {
                this.anchorPoint = new ValueCallbackKeyframeAnimation((LottieValueCallback<PointF>) lottieValueCallback, new PointF());
                return true;
            }
            baseKeyframeAnimation3.setValueCallback((LottieValueCallback<PointF>) lottieValueCallback);
            return true;
        } else if (t == LottieProperty.TRANSFORM_POSITION) {
            BaseKeyframeAnimation<?, PointF> baseKeyframeAnimation4 = this.position;
            if (baseKeyframeAnimation4 == null) {
                this.position = new ValueCallbackKeyframeAnimation((LottieValueCallback<PointF>) lottieValueCallback, new PointF());
                return true;
            }
            baseKeyframeAnimation4.setValueCallback((LottieValueCallback<PointF>) lottieValueCallback);
            return true;
        } else {
            if (t == LottieProperty.TRANSFORM_POSITION_X) {
                BaseKeyframeAnimation<?, PointF> baseKeyframeAnimation5 = this.position;
                if (baseKeyframeAnimation5 instanceof SplitDimensionPathKeyframeAnimation) {
                    ((SplitDimensionPathKeyframeAnimation) baseKeyframeAnimation5).setXValueCallback((LottieValueCallback<Float>) lottieValueCallback);
                    return true;
                }
            }
            if (t == LottieProperty.TRANSFORM_POSITION_Y) {
                ...
                if (baseKeyframeAnimation6 instanceof SplitDimensionPathKeyframeAnimation) {
                    ((SplitDimensionPathKeyframeAnimation) baseKeyframeAnimation6).setYValueCallback((LottieValueCallback<Float>) lottieValueCallback);
                    return true;
                }
            }
            if (t == LottieProperty.TRANSFORM_SCALE) {
                ...
                if (baseKeyframeAnimation7 == null) {
                    this.scale = new ValueCallbackKeyframeAnimation((LottieValueCallback<ScaleXY>) lottieValueCallback, new ScaleXY());
                    return true;
                }
                baseKeyframeAnimation7.setValueCallback((LottieValueCallback<ScaleXY>) lottieValueCallback);
                return true;
            } else if (t == LottieProperty.TRANSFORM_ROTATION) {
                BaseKeyframeAnimation<Float, Float> baseKeyframeAnimation8 = this.rotation;
                if (baseKeyframeAnimation8 == null) {
                    this.rotation = new ValueCallbackKeyframeAnimation((LottieValueCallback<Float>) lottieValueCallback, Float.valueOf(0.0f));
                    return true;
                }
                baseKeyframeAnimation8.setValueCallback((LottieValueCallback<Float>) lottieValueCallback);
                return true;
                ...
                if (baseKeyframeAnimation9 == null) {
                    this.opacity = new ValueCallbackKeyframeAnimation((LottieValueCallback<Integer>) lottieValueCallback, 100);
                    return true;
                }
                baseKeyframeAnimation9.setValueCallback((LottieValueCallback<Integer>) lottieValueCallback);
                return true;
                ...
                if (t != LottieProperty.TRANSFORM_END_OPACITY || (baseKeyframeAnimation = this.endOpacity) == null) {
                    if (t == LottieProperty.TRANSFORM_SKEW && (floatKeyframeAnimation2 = this.skew) != null) {
                        ...
                        this.skew.setValueCallback((LottieValueCallback<Float>) lottieValueCallback);
                        return true;
                        ...
                        this.skewAngle.setValueCallback((LottieValueCallback<Float>) lottieValueCallback);
                        return true;
                    }
                } else if (baseKeyframeAnimation == null) {
                    this.endOpacity = new ValueCallbackKeyframeAnimation((LottieValueCallback<Float>) lottieValueCallback, 100);
                    return true;
                } else {
                    baseKeyframeAnimation.setValueCallback((LottieValueCallback<Float>) lottieValueCallback);
                    return true;
                }
            } else if (baseKeyframeAnimation2 == null) {
                this.startOpacity = new ValueCallbackKeyframeAnimation((LottieValueCallback<Float>) lottieValueCallback, 100);
                return true;
            } else {
                baseKeyframeAnimation2.setValueCallback((LottieValueCallback<Float>) lottieValueCallback);
                return true;
            }
        }
    }
