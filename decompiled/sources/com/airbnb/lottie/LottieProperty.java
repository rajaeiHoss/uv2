...
public interface LottieProperty {
    public static final Float BLUR_RADIUS = Float.valueOf(17.0f);
    ...
    public static final Float DROP_SHADOW_DIRECTION = Float.valueOf(16.0f);
    public static final Float DROP_SHADOW_DISTANCE = Float.valueOf(17.0f);
    public static final Float DROP_SHADOW_OPACITY = Float.valueOf(15.0f);
