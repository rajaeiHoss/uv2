...
| `i2`, `j2`, ... | 4 |
| `z`, `z2`, ... | 6 |
| App-owned files with at least one generic identifier | 20 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 20 | 44 |
