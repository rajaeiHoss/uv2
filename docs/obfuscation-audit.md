...
| `i2`, `j2`, ... | 14 |
| `z`, `z2`, ... | 18 |
| App-owned files with at least one generic identifier | 47 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 47 | 269 |
