...
| `i2`, `j2`, ... | 1 |
| `z`, `z2`, ... | 4 |
| App-owned files with at least one generic identifier | 7 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 7 | 12 |
