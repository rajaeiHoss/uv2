...
| `i2`, `j2`, ... | 7 |
| `z`, `z2`, ... | 11 |
| App-owned files with at least one generic identifier | 35 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 35 | 128 |
...
- `decompiled/sources/com/streamax/client/fragment/FragmentBase.java`
