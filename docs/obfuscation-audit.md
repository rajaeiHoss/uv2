...
| `i2`, `j2`, ... | 6 |
| `z`, `z2`, ... | 9 |
| App-owned files with at least one generic identifier | 32 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 32 | 105 |
