...
| `i2`, `j2`, ... | 19 |
| `z`, `z2`, ... | 23 |
| App-owned files with at least one generic identifier | 58 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 58 | 473 |
