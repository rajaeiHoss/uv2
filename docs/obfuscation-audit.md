...
| `i2`, `j2`, ... | 14 |
| `z`, `z2`, ... | 20 |
| App-owned files with at least one generic identifier | 51 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 51 | 334 |
