...
| `i2`, `j2`, ... | 4 |
| `z`, `z2`, ... | 8 |
| App-owned files with at least one generic identifier | 24 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 24 | 59 |
