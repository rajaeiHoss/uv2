...
| `i2`, `j2`, ... | 33 |
| `z`, `z2`, ... | 34 |
| App-owned files with at least one generic identifier | 77 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 77 | 1,026 |
