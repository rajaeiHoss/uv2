...
| `i2`, `j2`, ... | 14 |
| `z`, `z2`, ... | 19 |
| App-owned files with at least one generic identifier | 50 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 50 | 317 |
