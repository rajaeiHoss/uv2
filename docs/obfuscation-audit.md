...
| `i2`, `j2`, ... | 17 |
| `z`, `z2`, ... | 22 |
| App-owned files with at least one generic identifier | 56 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 56 | 429 |
