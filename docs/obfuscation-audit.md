...
| `i2`, `j2`, ... | 9 |
| `z`, `z2`, ... | 13 |
| App-owned files with at least one generic identifier | 37 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 37 | 145 |
