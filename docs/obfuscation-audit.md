...
| `i2`, `j2`, ... | 11 |
| `z`, `z2`, ... | 16 |
| App-owned files with at least one generic identifier | 40 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 40 | 175 |
