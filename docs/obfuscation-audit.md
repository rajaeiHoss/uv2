...
| `i2`, `j2`, ... | 58 |
| `z`, `z2`, ... | 47 |
| App-owned files with at least one generic identifier | 104 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 104 | 2,799 |
