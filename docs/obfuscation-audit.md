...
| `i2`, `j2`, ... | 3 |
| `z`, `z2`, ... | 6 |
| App-owned files with at least one generic identifier | 17 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 17 | 35 |
