...
| `i2`, `j2`, ... | 21 |
| `z`, `z2`, ... | 25 |
| App-owned files with at least one generic identifier | 63 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 63 | 594 |
