...
| `i2`, `j2`, ... | 43 |
| `z`, `z2`, ... | 38 |
| App-owned files with at least one generic identifier | 88 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 88 | 1,465 |
