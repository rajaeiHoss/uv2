...
| `i2`, `j2`, ... | 4 |
| `z`, `z2`, ... | 7 |
| App-owned files with at least one generic identifier | 21 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 21 | 47 |
