...
| `i2`, `j2`, ... | 5 |
| `z`, `z2`, ... | 9 |
| App-owned files with at least one generic identifier | 29 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 29 | 86 |
