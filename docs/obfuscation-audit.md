...
| `i2`, `j2`, ... | 1 |
| `z`, `z2`, ... | 3 |
| App-owned files with at least one generic identifier | 5 |

Top app-owned cleanup targets by generic identifier count:

| File | Generic identifier hits |
| --- | ---: |
| `decompiled/sources/com/streamax/client/app/AppAdapter.java` | 2 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 5 | 8 |
