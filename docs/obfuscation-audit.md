...
| `i2`, `j2`, ... | 22 |
| `z`, `z2`, ... | 26 |
| App-owned files with at least one generic identifier | 64 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 64 | 621 |
