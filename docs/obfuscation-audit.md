...
| `i2`, `j2`, ... | 41 |
| `z`, `z2`, ... | 38 |
| App-owned files with at least one generic identifier | 86 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 86 | 1,374 |
