...
| `i2`, `j2`, ... | 1 |
| `z`, `z2`, ... | 1 |
| App-owned files with at least one generic identifier | 2 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 2 | 2 |
