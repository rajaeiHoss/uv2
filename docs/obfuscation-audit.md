...
| `i2`, `j2`, ... | 23 |
| `z`, `z2`, ... | 27 |
| App-owned files with at least one generic identifier | 65 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 65 | 650 |
...
- `decompiled/sources/com/streamax/client/ui/devlist/CustomExpandAdapter.java`
