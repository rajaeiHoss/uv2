...
| `i2`, `j2`, ... | 31 |
| `z`, `z2`, ... | 32 |
| App-owned files with at least one generic identifier | 73 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 73 | 893 |
