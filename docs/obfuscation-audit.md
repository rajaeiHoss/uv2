...
| `i2`, `j2`, ... | 14 |
| `z`, `z2`, ... | 18 |
| App-owned files with at least one generic identifier | 48 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 48 | 285 |
