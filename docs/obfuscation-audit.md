...
| `i2`, `j2`, ... | 10 |
| `z`, `z2`, ... | 15 |
| App-owned files with at least one generic identifier | 39 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 39 | 165 |
