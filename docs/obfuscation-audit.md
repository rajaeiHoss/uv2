...
| `i2`, `j2`, ... | 4 |
| `z`, `z2`, ... | 8 |
| App-owned files with at least one generic identifier | 22 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 22 | 51 |
