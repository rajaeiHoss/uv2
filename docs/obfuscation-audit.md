...
| `i2`, `j2`, ... | 47 |
| `z`, `z2`, ... | 38 |
| App-owned files with at least one generic identifier | 91 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 91 | 1,620 |
