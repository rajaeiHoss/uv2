...
| `i2`, `j2`, ... | 48 |
| `z`, `z2`, ... | 39 |
| App-owned files with at least one generic identifier | 93 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 93 | 1,736 |
