...
| `i2`, `j2`, ... | 49 |
| `z`, `z2`, ... | 39 |
| App-owned files with at least one generic identifier | 94 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 94 | 1,796 |
