...
| `i2`, `j2`, ... | 35 |
| `z`, `z2`, ... | 35 |
| App-owned files with at least one generic identifier | 79 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 79 | 1,096 |
