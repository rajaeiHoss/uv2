...
| `i2`, `j2`, ... | 24 |
| `z`, `z2`, ... | 28 |
| App-owned files with at least one generic identifier | 66 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 66 | 679 |
