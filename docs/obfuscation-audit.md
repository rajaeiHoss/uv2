...
| `i2`, `j2`, ... | 15 |
| `z`, `z2`, ... | 20 |
| App-owned files with at least one generic identifier | 52 |
...
| `decompiled/sources/com/streamax/client/DbHelper.java` | 8 |
| `decompiled/sources/com/streamax/utils/SingleFragment.java` | 7 |

Generic identifier concentration by app-owned namespace:

| Namespace | Files | Hits |
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 52 | 351 |
...
- `decompiled/sources/com/streamax/view/VsTextView.java`
- `decompiled/sources/com/streamax/config/base/BaseFragment.java`
