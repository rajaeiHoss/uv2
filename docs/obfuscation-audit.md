...
| `i2`, `j2`, ... | 9 |
| `z`, `z2`, ... | 14 |
| App-owned files with at least one generic identifier | 38 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 38 | 155 |
