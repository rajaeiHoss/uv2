...
| `i2`, `j2`, ... | 13 |
| `z`, `z2`, ... | 16 |
| App-owned files with at least one generic identifier | 42 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 42 | 198 |
