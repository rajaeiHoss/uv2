...
| `i2`, `j2`, ... | 30 |
| `z`, `z2`, ... | 31 |
| App-owned files with at least one generic identifier | 72 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 72 | 862 |
