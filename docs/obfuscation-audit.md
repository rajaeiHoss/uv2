...
| `i2`, `j2`, ... | 0 |
| `z`, `z2`, ... | 1 |
| App-owned files with at least one generic identifier | 1 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 1 | 1 |
