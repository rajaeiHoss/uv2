...
| `i2`, `j2`, ... | 14 |
| `z`, `z2`, ... | 16 |
| App-owned files with at least one generic identifier | 43 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 43 | 211 |
...
- `decompiled/sources/com/streamax/client/LoginActivity.java`
- `decompiled/sources/com/streamax/config/fragment/network/FtpOfNetwork.java`
- `decompiled/sources/com/streamax/view/VsEditView.java`
