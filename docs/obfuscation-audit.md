...
| `i2`, `j2`, ... | 4 |
| `z`, `z2`, ... | 6 |
| App-owned files with at least one generic identifier | 19 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 19 | 41 |
