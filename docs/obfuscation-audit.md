...
| `i2`, `j2`, ... | 31 |
| `z`, `z2`, ... | 32 |
| App-owned files with at least one generic identifier | 74 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 74 | 925 |
