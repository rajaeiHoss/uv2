...
| `i2`, `j2`, ... | 14 |
| `z`, `z2`, ... | 17 |
| App-owned files with at least one generic identifier | 45 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 45 | 239 |
