...
| `i2`, `j2`, ... | 0 |
| `z`, `z2`, ... | 0 |
| App-owned files with at least one generic identifier | 0 |

Top app-owned cleanup targets by generic identifier count:

No app-owned Java files currently match this generic-identifier scan.

Generic identifier concentration by app-owned namespace:

| Namespace | Files | Hits |
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 0 | 0 |
