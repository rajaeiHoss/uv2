...
| `i2`, `j2`, ... | 2 |
| `z`, `z2`, ... | 6 |
| App-owned files with at least one generic identifier | 16 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 16 | 32 |
