...
| `i2`, `j2`, ... | 14 |
| `z`, `z2`, ... | 16 |
| App-owned files with at least one generic identifier | 44 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 44 | 225 |
