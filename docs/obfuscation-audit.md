...
| `i2`, `j2`, ... | 12 |
| `z`, `z2`, ... | 16 |
| App-owned files with at least one generic identifier | 41 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 41 | 186 |
