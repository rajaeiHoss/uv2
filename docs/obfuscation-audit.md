...
| `i2`, `j2`, ... | 31 |
| `z`, `z2`, ... | 32 |
| App-owned files with at least one generic identifier | 75 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 75 | 958 |
