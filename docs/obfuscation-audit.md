...
| `i2`, `j2`, ... | 39 |
| `z`, `z2`, ... | 37 |
| App-owned files with at least one generic identifier | 84 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 84 | 1,288 |
