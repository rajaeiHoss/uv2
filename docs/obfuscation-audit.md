...
| `i2`, `j2`, ... | 58 |
| `z`, `z2`, ... | 46 |
| App-owned files with at least one generic identifier | 103 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 103 | 2,659 |
