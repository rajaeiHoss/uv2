...
| `i2`, `j2`, ... | 45 |
| `z`, `z2`, ... | 38 |
| App-owned files with at least one generic identifier | 90 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 90 | 1,566 |
