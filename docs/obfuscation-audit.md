...
| `i2`, `j2`, ... | 18 |
| `z`, `z2`, ... | 22 |
| App-owned files with at least one generic identifier | 57 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 57 | 451 |
