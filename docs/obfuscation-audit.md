...
| `i2`, `j2`, ... | 4 |
| `z`, `z2`, ... | 6 |
| App-owned files with at least one generic identifier | 18 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 18 | 38 |
