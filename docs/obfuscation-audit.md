...
| `i2`, `j2`, ... | 51 |
| `z`, `z2`, ... | 40 |
| App-owned files with at least one generic identifier | 96 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 96 | 1,943 |
