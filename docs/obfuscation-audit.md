...
| `i2`, `j2`, ... | 25 |
| `z`, `z2`, ... | 29 |
| App-owned files with at least one generic identifier | 67 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 67 | 709 |
