...
| `i2`, `j2`, ... | 26 |
| `z`, `z2`, ... | 29 |
| App-owned files with at least one generic identifier | 68 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 68 | 739 |
...
- `decompiled/sources/com/streamax/client/LocalPlaybackActivity.java`
- `decompiled/sources/com/streamax/client/VideoFrame.java`
- `decompiled/sources/com/streamax/client/MainActivity.java`
