...
| `i2`, `j2`, ... | 1 |
| `z`, `z2`, ... | 5 |
| App-owned files with at least one generic identifier | 13 |

Top app-owned cleanup targets by generic identifier count:

| File | Generic identifier hits |
| --- | ---: |
| `decompiled/sources/com/streamax/utils/AppProxy.java` | 2 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 13 | 24 |
