...
| `i2`, `j2`, ... | 32 |
| `z`, `z2`, ... | 33 |
| App-owned files with at least one generic identifier | 76 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 76 | 992 |
