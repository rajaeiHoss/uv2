...
| `i2`, `j2`, ... | 20 |
| `z`, `z2`, ... | 24 |
| App-owned files with at least one generic identifier | 62 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 62 | 568 |
