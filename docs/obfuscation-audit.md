...
| `i2`, `j2`, ... | 59 |
| `z`, `z2`, ... | 49 |
| App-owned files with at least one generic identifier | 105 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 105 | 3,118 |
