...
| `i2`, `j2`, ... | 6 |
| `z`, `z2`, ... | 10 |
| App-owned files with at least one generic identifier | 33 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 33 | 112 |
