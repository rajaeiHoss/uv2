...
| `i2`, `j2`, ... | 4 |
| `z`, `z2`, ... | 9 |
| App-owned files with at least one generic identifier | 28 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 28 | 80 |
