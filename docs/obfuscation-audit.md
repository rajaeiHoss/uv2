...
| `i2`, `j2`, ... | 14 |
| `z`, `z2`, ... | 18 |
| App-owned files with at least one generic identifier | 49 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 49 | 301 |
...
- `decompiled/sources/com/streamax/client/InitDevInfoBean.java`
- `decompiled/sources/com/streamax/client/FileUtils.java`
