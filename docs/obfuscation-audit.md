...
| `i2`, `j2`, ... | 1 |
| `z`, `z2`, ... | 2 |
| App-owned files with at least one generic identifier | 3 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 3 | 4 |
