...
| `i2`, `j2`, ... | 1 |
| `z`, `z2`, ... | 6 |
| App-owned files with at least one generic identifier | 14 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 14 | 26 |
