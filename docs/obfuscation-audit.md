...
| `i2`, `j2`, ... | 4 |
| `z`, `z2`, ... | 8 |
| App-owned files with at least one generic identifier | 26 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 26 | 69 |
