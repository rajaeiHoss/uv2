...
| `i2`, `j2`, ... | 52 |
| `z`, `z2`, ... | 41 |
| App-owned files with at least one generic identifier | 97 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 97 | 2,027 |
