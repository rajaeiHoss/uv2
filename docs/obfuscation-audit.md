...
| `i2`, `j2`, ... | 1 |
| `z`, `z2`, ... | 4 |
| App-owned files with at least one generic identifier | 9 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 9 | 16 |
