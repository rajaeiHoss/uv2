...
| `i2`, `j2`, ... | 8 |
| `z`, `z2`, ... | 12 |
| App-owned files with at least one generic identifier | 36 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 36 | 136 |
...
- `decompiled/sources/com/streamax/client/DbHelper.java`
- `decompiled/sources/com/streamax/utils/SingleFragment.java`
