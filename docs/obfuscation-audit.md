...
| `i2`, `j2`, ... | 19 |
| `z`, `z2`, ... | 23 |
| App-owned files with at least one generic identifier | 61 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 61 | 542 |
