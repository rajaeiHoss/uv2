...
| `i2`, `j2`, ... | 27 |
| `z`, `z2`, ... | 29 |
| App-owned files with at least one generic identifier | 69 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 69 | 769 |
