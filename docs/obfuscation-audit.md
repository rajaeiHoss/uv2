...
| `i2`, `j2`, ... | 1 |
| `z`, `z2`, ... | 4 |
| App-owned files with at least one generic identifier | 12 |

Top app-owned cleanup targets by generic identifier count:

| File | Generic identifier hits |
| --- | ---: |
| `decompiled/sources/com/streamax/config/fragment/network/UpnpOfNetwork.java` | 2 |
| `decompiled/sources/com/streamax/config/fragment/SystemInfoFragment.java` | 2 |
| `decompiled/sources/com/streamax/config/fragment/SelectFragment.java` | 2 |
| `decompiled/sources/com/streamax/config/fragment/FragmentDevInfo.java` | 2 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 12 | 22 |
