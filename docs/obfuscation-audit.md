...
| `i2`, `j2`, ... | 38 |
| `z`, `z2`, ... | 36 |
| App-owned files with at least one generic identifier | 83 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 83 | 1,247 |
