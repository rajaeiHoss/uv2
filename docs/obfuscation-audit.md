...
| `i2`, `j2`, ... | 7 |
| `z`, `z2`, ... | 10 |
| App-owned files with at least one generic identifier | 34 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 34 | 120 |
...
- `decompiled/sources/com/streamax/config/utils/ImageUtils.java`
