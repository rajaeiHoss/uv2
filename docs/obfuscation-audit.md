...
| `i2`, `j2`, ... | 37 |
| `z`, `z2`, ... | 35 |
| App-owned files with at least one generic identifier | 82 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 82 | 1,208 |
