...
| `i2`, `j2`, ... | 50 |
| `z`, `z2`, ... | 39 |
| App-owned files with at least one generic identifier | 95 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 95 | 1,866 |
