...
| `i2`, `j2`, ... | 42 |
| `z`, `z2`, ... | 38 |
| App-owned files with at least one generic identifier | 87 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 87 | 1,419 |
