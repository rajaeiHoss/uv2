...
| `i2`, `j2`, ... | 55 |
| `z`, `z2`, ... | 43 |
| App-owned files with at least one generic identifier | 100 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 100 | 2,313 |
