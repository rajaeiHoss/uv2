...
| `i2`, `j2`, ... | 62 |
| `z`, `z2`, ... | 50 |
| App-owned files with at least one generic identifier | 109 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 109 | 4,122 |
