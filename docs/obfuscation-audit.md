...
| `i2`, `j2`, ... | 63 |
| `z`, `z2`, ... | 50 |
| App-owned files with at least one generic identifier | 110 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 110 | 4,410 |
