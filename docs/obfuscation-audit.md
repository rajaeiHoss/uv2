...
| `i2`, `j2`, ... | 1 |
| `z`, `z2`, ... | 2 |
| App-owned files with at least one generic identifier | 4 |

Top app-owned cleanup targets by generic identifier count:

| File | Generic identifier hits |
| --- | ---: |
| `decompiled/sources/com/streamax/client/PlaybackActivity.java` | 2 |
| `decompiled/sources/com/streamax/client/LocalRecordFileList.java` | 2 |
| `decompiled/sources/com/streamax/config/db/DeviceInfoHelper.java` | 1 |
| `decompiled/sources/com/streamax/client/app/AppActivity.java` | 1 |

Generic identifier concentration by app-owned namespace:

| Namespace | Files | Hits |
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 4 | 6 |
