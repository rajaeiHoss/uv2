...
| `i2`, `j2`, ... | 14 |
| `z`, `z2`, ... | 17 |
| App-owned files with at least one generic identifier | 46 |
...
| `decompiled/sources/com/streamax/client/fragment/FragmentBase.java` | 7 |
| `decompiled/sources/com/streamax/config/utils/ImageUtils.java` | 6 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 46 | 253 |
