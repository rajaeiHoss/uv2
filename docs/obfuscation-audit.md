...
| `i2`, `j2`, ... | 44 |
| `z`, `z2`, ... | 38 |
| App-owned files with at least one generic identifier | 89 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 89 | 1,512 |
...
- `decompiled/sources/com/streamax/config/fragment/FragmentSysTime.java`
- `decompiled/sources/com/streamax/client/ui/dialog/DateDialog.java`
