...
| `i2`, `j2`, ... | 6 |
| `z`, `z2`, ... | 9 |
| App-owned files with at least one generic identifier | 31 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 31 | 98 |
