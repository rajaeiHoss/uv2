...
| `i2`, `j2`, ... | 1 |
| `z`, `z2`, ... | 3 |
| App-owned files with at least one generic identifier | 6 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 6 | 10 |
