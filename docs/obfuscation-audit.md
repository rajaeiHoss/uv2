...
| `i2`, `j2`, ... | 28 |
| `z`, `z2`, ... | 30 |
| App-owned files with at least one generic identifier | 70 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 70 | 800 |
