...
| `i2`, `j2`, ... | 34 |
| `z`, `z2`, ... | 35 |
| App-owned files with at least one generic identifier | 78 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 78 | 1,061 |
