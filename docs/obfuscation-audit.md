...
| `i2`, `j2`, ... | 16 |
| `z`, `z2`, ... | 21 |
| App-owned files with at least one generic identifier | 53 |
...
| --- | ---: | ---: |
| `decompiled/sources/com/streamax` | 53 | 369 |
